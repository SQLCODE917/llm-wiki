...
projection_coverage: topic-javascriptallonge-closure@61c93515fb5f67c35466bcebbcea0b7c
---
...
- [[javascriptallonge-evaluate]] - shared technical atoms: Evaluate shares technical record from And also: / Closures and Scope / it's always the environment: So whenever a function is applied to arguments, its environment always has a reference to its parent environment. (1 shared atom(s))
