---
page_id: javascriptallonge-section-gathering-c3f6d27a
page_kind: source
...
projection_coverage: section-javascriptallonge-section-gathering-c3f6d27a@a5ca14cc667faaccc840e8280900adc4
---
...
- Sometimes we need to extract arrays from arrays. Here is the most common pattern: Extracting the head and gathering everything but the head from an array: _(javascriptallonge.pdf (source-range-8eb13d6b-00853))_
- car and cdr 57 are archaic terms that go back to an implementation of Lisp running on the IBM 704 computer. Some other languages call them first and butFirst , or head and tail . We will use a common convention and call variables we gather rest , but refer to the ... operation as a 'gather,' following Kyle Simpson's example. 58 _(javascriptallonge.pdf (source-range-8eb13d6b-00855))_
- Alas, the ... notation does not provide a universal patten-matching capability. For example, we cannot write _(javascriptallonge.pdf (source-range-8eb13d6b-00856))_

## Technical atoms

### Technical frame 1: gathering

**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-00855))_
