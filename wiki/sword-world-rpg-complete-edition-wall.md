---
page_id: sword-world-rpg-complete-edition-wall
page_kind: concept
summary: Wall: 40 statement(s) and 8 atom(s) from raw/Sword World RPG - Complete Edition.pdf.
sources: raw/Sword World RPG - Complete Edition.pdf
updated: 2026-06-29
domain: sword-world-rpg-complete-edition
category_path: concepts
projection_coverage: topic-sword-world-rpg-complete-edition-wall@5d903ed2e95874d7b6b7e42118186950
---

# Wall

What [[sword-world-rpg-complete-edition]] covers about wall:
...
- [[sword-world-rpg-complete-edition-spirit]] - shared statements and technical atoms: Spirit shares source evidence from 2nd Level Spirit Magic List [ Will-O-Wisp ] (Will-O-Wisp/Light Spirit): Counters (Negates): Shade , Spirit Wall: Shade Countered (Negated) By: Shade , Spirit Wall: Shade; Spirit shares technical record from [ Spirit Wall ]: There are also walls that you cannot pass through, walls that deal damage even if you force your way through, etc. (8 shared statement(s), 6 shared atom(s))
- [[sword-world-rpg-complete-edition-light]] - shared statements and technical atoms: Light shares source evidence from [ Spirit Wall ]: With the help of the spirit of light, you can build a dazzling wall of light. The wall of light is not a solid entity, but a collection of will-o-wisps themselves. T ... [truncated]; Light shares technical record from [ Spirit Wall ]: Expansion=Final score, duration, distance, target volume, damage certainty Resist=Reduced effect (4 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-spell]] - shared technical atoms: Spell shares technical record from [ Spirit Wall ]: Type=Target score, damage (Pure energytype) (2 shared atom(s))
- [[sword-world-rpg-complete-edition-type]] - shared technical atoms: Type shares technical record from [ Spirit Wall ]: Type=Target score, damage (Pure energytype) (1 shared atom(s))
- [[sword-world-rpg-complete-edition-fire]] - shared statements: Fire shares source evidence from [ Spirit Wall ]: Create a wall of blazing fire by borrowing the power of the fire spirit. When you chant this spell, tongues of fire rush everywhere, swell up as if they're going to ... [truncated] (2 shared statement(s))
- [[sword-world-rpg-complete-edition-adventure]] - shared statements: Adventure shares source evidence from Resistance Rolls: Since Ducard II has an adventurer level of 2 and a +2 mental power bonus, the baseline score of his mental power resistance roll (mental power resistance power) is 4 ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-character]] - shared statements: Character shares source evidence from Destruction Points: If a character attacks with a weapon and deals 22 or greater points of damage in one blow, this wooden wall will be destroyed. If the damage is 7 points or less , th ... [truncated] (1 shared statement(s))
...
- [[sword-world-rpg-complete-edition-thief]] - shared statements: Thief shares source evidence from Chapter 6: / [ ④ Climb [Agility] ]: Note that when a thief climbs up or down a wall or cliff without using a rope, the conditions marked * are not possible. (1 shared statement(s))
