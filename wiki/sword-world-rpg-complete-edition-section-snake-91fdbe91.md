...
page_kind: source
summary: [ Snake ]: 37 source-backed entries and 19 atom(s) from raw/Sword World RPG - Complete Edition.pdf.
...
- There are many different types of snakes in Forcelia. Here we will introduce four types of potentially dangerous monsters. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-08335))_
...
- A python is a giant snake that can reach up to 10 meters in length. When it attacks its prey, it entangles it with its body and tries to strangle it to death. This attack resolves as strangling (see p. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-08345))_
- 236). They are not poisonous. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-08346))_
...
- Its fangs are poisonous, and those bitten must succeed on a life force resistance roll against target score 9 or die from the poison after one hour. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-08339))_
- This hypnotic state lasts as long as the hypnopython dances within your view, so if there's no one around to help you, you will be swallowed by the python without resistance. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-08362))_
