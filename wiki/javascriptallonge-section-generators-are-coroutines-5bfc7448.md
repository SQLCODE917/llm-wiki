---
page_id: javascriptallonge-section-generators-are-coroutines-5bfc7448
page_kind: source
...
projection_coverage: section-javascriptallonge-section-generators-are-coroutines-5bfc7448@2051af45cae013a449e4b59b723dd3e2
---
...
- This is where generators behave very, very differently from ordinary functions. What happens semantically ? _(javascriptallonge.pdf (source-range-31a4cf47-01680))_
...
- Of course, generators need not be implemented exactly as coroutines. For example, a 'transpiler' might implement oneTwoThree as a state machine, a little like this (there is more to generators, but we'll see that later): _(javascriptallonge.pdf (source-range-31a4cf47-01705))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-01680))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-01707))_
