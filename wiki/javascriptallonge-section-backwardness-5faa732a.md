---
page_id: javascriptallonge-section-backwardness-5faa732a
page_kind: source
...
projection_coverage: section-javascriptallonge-section-backwardness-5faa732a@741063cba8213a1a1fd66acc7b274c62
---
...
- But the first and second we built out of K and I don't work that way. You call them and pass them the bits, and they choose what to return. So if we wanted to use them with a two-element array, we'd need to have a piece of code that calls some code. _(javascriptallonge.pdf (source-range-31a4cf47-01359))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-01362))_
