---
page_id: javascriptallonge-section-destructuring-arrays-fcc591d2
page_kind: source
...
projection_coverage: section-javascriptallonge-section-destructuring-arrays-fcc591d2@e88a3cff75416c33c3101f6b4728c97f
---
...
- There is another way to extract elements from arrays: Destructuring , a feature going back to Common Lisp, if not before. We saw how to construct an array literal using [ , expressions, , and ] . Here's an example of an array literal that uses a name: _(javascriptallonge.pdf (source-range-8eb13d6b-00841))_
- The line const wrapped = [something]; is interesting. On the left hand is a name to be bound, and on the right hand is an array literal, a template for constructing an array, very much like a quasi-literal string. _(javascriptallonge.pdf (source-range-8eb13d6b-00844))_
...
**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-00844))_
