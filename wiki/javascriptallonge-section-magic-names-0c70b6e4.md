---
page_id: javascriptallonge-section-magic-names-0c70b6e4
page_kind: source
page_family: section-reference
summary: Magic Names: 18 source-backed entries and 1 atom(s) from raw/javascriptallonge.pdf.
sources: raw/javascriptallonge.pdf
updated: 2026-07-03
domain: javascriptallonge
category_path: sources/javascriptallonge/sections
source_id: javascriptallonge.pdf
projection_coverage: section-javascriptallonge-section-magic-names-0c70b6e4@d6ee1f02155ededcaab1d0f8f8c2cb17
---
...
> 43We’ll look at arrays and plain old javascript objects in depth later. _(javascriptallonge.pdf (source-range-af806fb1-00086))_
- 52 
...
For example, when this expression’s inner function is defined with function, arguments[0] refers to its only argument, "inner": _(javascriptallonge.pdf (source-range-af806fb1-00087))_
- The first sip: Basic Functions 
...
Having magic variables apply to Big-F functions but not to small-G functions makes it much easier to use small-F functions as syntax, treating them as expressions or blocks that can be passed to functions like mapWith. _(javascriptallonge.pdf (source-range-af806fb1-00089))_
- It is wise to treat them as read-only at all times. _(javascriptallonge.pdf (source-range-af806fb1-00086))_
- For example, when this expression’s inner function is defined with function, arguments[0] refers to its only argument, "inner": _(javascriptallonge.pdf (source-range-af806fb1-00087))_
- It has a name, it is called by different pieces of code, it’s a first-class entity in the code. _(javascriptallonge.pdf (source-range-af806fb1-00089))_

## Technical atoms

### Technical frame 1: Magic Names

**Context:** _(javascriptallonge.pdf (source-range-af806fb1-00089))_
...
Although this example is clearly unrealistic, there is a general design principle that de

**Atom:** _(javascriptallonge.pdf (source-range-af806fb1-00088))_

<a id="atom-technical-atom-3a603deb63bff35b"></a>
