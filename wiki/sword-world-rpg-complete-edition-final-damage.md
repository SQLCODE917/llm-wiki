...
projection_coverage: topic-sword-world-rpg-complete-edition-final-damage@e43c86aa798b4d9c5da1f281d7f5213c
---
...
- [[sword-world-rpg-complete-edition-final]] - broader topic: Final shares source evidence from 4.6.5 Final Damage: The final damage your character suffers from a monster equals the monster's strike points minus the result of your defense roll plus your character's damage reduction .; Final shares technical record from 4.6.5 Final Damage: Example: If the base damage dealt by Ducard II is 4,  18 ,  or 14 ,  respectively,  the  final damage  he  could  deal  to  the  goblin would be: 4 (base damage) +4 ... [truncated] (8 shared statement(s), 4 shared atom(s))
- [[sword-world-rpg-complete-edition-score]] - shared statements and technical atoms: Score shares source evidence from Example:: Suppose a sorcerer casts an Energy Bolt on three enemies ( x 3 expansion) with a +1 to his final score ( x 2 expansion) and he makes 4 damage checks for each ( x 4 e ... [truncated]; Score shares technical table: Table 6-2: Determining Climb Target Scores failure. Base Target Score = 10 Modifier due to wall and cliff foothold conditions: A  check must  be made every 10 *No wa ... [truncated] (5 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-base]] - shared statements and technical atoms: Base shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Base shares technical table: Example: If the base damage dealt by Ducard II is 4,  18 ,  or 14 ,  respectively,  the  final damage  he  could  deal  to  the  goblin would be: 4 (base damage) +4 ... [truncated] (2 shared statement(s), 3 shared atom(s))
- [[sword-world-rpg-complete-edition-defense]] - shared statements and technical atoms: Defense shares source evidence from 4.6.5 Final Damage: The final damage your character suffers from a monster equals the monster's strike points minus the result of your defense roll plus your character's damage reduction .; Defense shares technical record from 4.6.5 Final Damage: Example: If the base damage dealt by Ducard II is 4,  18 ,  or 14 ,  respectively,  the  final damage  he  could  deal  to  the  goblin would be: 4 (base damage) +4 ... [truncated] (2 shared statement(s), 3 shared atom(s))
- [[sword-world-rpg-complete-edition-strike]] - shared statements and technical atoms: Strike shares source evidence from 4.6.5 Final Damage: The final damage your character suffers from a monster equals the monster's strike points minus the result of your defense roll plus your character's damage reduction .; Strike shares technical record from 4.6.5 Final Damage: Example: If  the  result  of  Ducard  II's  defense roll is 0 (roll 3) or 6 (roll 12), respectively, the final damage he will suffer is calculated to be: 7 (goblin's ... [truncated] (3 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-target]] - shared statements and technical atoms: Target shares source evidence from [ Shade ] (Shade/Dark Spirit): Expansion=Final score, duration, distance, targets, damage certainty Resist=Reduced effect Shade is the spirit of darkness that opposes will-o-wisp, and is also the ... [truncated]; Target shares technical table: Table 6-2: Determining Climb Target Scores failure. Base Target Score = 10 Modifier due to wall and cliff foothold conditions: A  check must  be made every 10 *No wa ... [truncated] (2 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-result]] - shared statements and technical atoms: Result shares source evidence from 4.6.5 Final Damage: The final damage your character suffers from a monster equals the monster's strike points minus the result of your defense roll plus your character's damage reduction .; Result shares technical record from 4.6.5 Final Damage: Example: If  the  result  of  Ducard  II's  defense roll is 0 (roll 3) or 6 (roll 12), respectively, the final damage he will suffer is calculated to be: 7 (goblin's ... [truncated] (1 shared statement(s), 2 shared atom(s))
...
- [[sword-world-rpg-complete-edition-table]] - shared technical atoms: Table shares technical table: Table 4-3: Rating Table, Key Number Example:                               If final damage is 0 or negative, that Column 7 Suppose Ducard II’s defense roll came    m ... [truncated] (4 shared atom(s))
- [[sword-world-rpg-complete-edition-bonus]] - shared technical atoms: Bonus shares technical table: Example: If the base damage dealt by Ducard II is 4,  18 ,  or 14 ,  respectively,  the  final damage  he  could  deal  to  the  goblin would be: 4 (base damage) +4 ... [truncated] (2 shared atom(s))
...
- [[sword-world-rpg-complete-edition-resist]] - shared statements: Resist shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated] (4 shared statement(s))
- [[sword-world-rpg-complete-edition-area]] - shared statements: Area shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated] (3 shared statement(s))
- [[sword-world-rpg-complete-edition-cast]] - shared statements: Cast shares source evidence from Example:: Suppose a sorcerer casts an Energy Bolt on three enemies ( x 3 expansion) with a +1 to his final score ( x 2 expansion) and he makes 4 damage checks for each ( x 4 e ... [truncated] (2 shared statement(s))
- [[sword-world-rpg-complete-edition-effect]] - shared statements: Effect shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated] (2 shared statement(s))
...
- [[sword-world-rpg-complete-edition-power]] - shared statements: Power shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated] (2 shared statement(s))
...
- [[sword-world-rpg-complete-edition-type]] - shared statements: Type shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated] (2 shared statement(s))
...
- [[sword-world-rpg-complete-edition-poison]] - shared statements: Poison shares source evidence from Chapter 11: Notes on Magic / Damage Poison: Deals damage to the opponent's life force (points). First, make a strike roll with a strike power of 20. Magic power should be added to damage as usual. Also, your o ... [truncated] (1 shared statement(s))
...
- [[sword-world-rpg-complete-edition-section-4-5-5-final-damage-b58b3174]] - source section: 4.5.5 Final Damage shares technical record from 4.5.5 Final Damage: final damage = base damage + bonus damage - monster's defense points (4 shared atom(s))
- [[sword-world-rpg-complete-edition-section-4-6-5-final-damage-e3713cd6]] - source section: 4.6.5 Final Damage shares source evidence from 4.6.5 Final Damage: The final damage your character suffers from a monster equals the monster's strike points minus the result of your defense roll plus your character's damage reduction .; 4.6.5 Final Damage shares technical record from 4.6.5 Final Damage: Example: If the base damage dealt by Ducard II is 4,  18 ,  or 14 ,  respectively,  the  final damage  he  could  deal  to  the  goblin would be: 4 (base damage) +4 ... [truncated] (4 shared statement(s), 7 shared atom(s))
