---
page_id: javascriptallonge-section-destructuring-is-not-pattern-matching-b7f29770
page_kind: source
...
projection_coverage: section-javascriptallonge-section-destructuring-is-not-pattern-matching-b7f29770@9830b40d41970337731d7cc47b13f93d
---
...
- Some other languages have something called pattern matching , where you can write something like a destructuring assignment, and the language decides whether the 'patterns' matches at all. If it does, assignments are made where appropriate. _(javascriptallonge.pdf (source-range-31a4cf47-00862))_
