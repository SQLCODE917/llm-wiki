...
- Roll 2D and follow the row next to the result. Then, look for the number under the appropriate column. This process is specifically called a defense roll . _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-02214))_
- Let's find out how much damage Ducard II is able to prevent with his armor after being attacked by the goblin. Since Ducard II has a defense power of 7 , we'll use key number column 7. We roll 2D, and the result is 3 . The number on row 3 under key number column 7 is 0 . This is the damage that Ducard II is able to prevent with his armor. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-02216))_
- For example, if your defense power is 7, you would look at key number column 7 with on the Rating Table . _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-02211))_
