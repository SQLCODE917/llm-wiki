---
page_id: javascriptallonge-section-that-constant-coffee-craving-2d5b9903
page_kind: source
page_family: section-reference
summary: That Constant Coffee Craving: 63 source-backed entries and 0 atom(s) from raw/javascriptallonge.pdf.
sources: raw/javascriptallonge.pdf
updated: 2026-07-03
domain: javascriptallonge
category_path: sources/javascriptallonge/sections
source_id: javascriptallonge.pdf
projection_coverage: section-javascriptallonge-section-that-constant-coffee-craving-2d5b9903@b57d1affdd5d5da666891c045489e808
---
...
28https://en.wikipedia.org/wiki/Pi _(javascriptallonge.pdf (source-range-af806fb1-00061))_
- 27 
...
And we could use it like this: _(javascriptallonge.pdf (source-range-af806fb1-00063))_
- 29 
...
We write: _(javascriptallonge.pdf (source-range-af806fb1-00064))_
- 30 
...
> 30We’re into the second chapter and we’ve finally named a function. Sheesh. _(javascriptallonge.pdf (source-range-af806fb1-00065))_
- The first sip: Basic Functions 
...
(n) => { **const** even = (x) => { **if** (x === 0) **return true** ; **else** { **const** odd = (y) => !even(y); **return** odd(x - 1); } _(javascriptallonge.pdf (source-range-af806fb1-00066))_
- 32 
...
It’s more than a bit convoluted, but it binds ((PI) => (diameter) => diameter * PI)(3.14159265) to diameter_fn and evaluates the expression that we’ve elided. We can use any expression in there, and that expression can invoke diameter_fn. For example: _(javascriptallonge.pdf (source-range-af806fb1-00067))_
- 33 
...
31https://en.wikipedia.org/wiki/Scope_(computer_science)#Lexical_scope_vs._dynamic_scope _(javascriptallonge.pdf (source-range-af806fb1-00068))_
- 34 
...
And gratuitously wrap it in another IIFE so that we can bind PI to something else: _(javascriptallonge.pdf (source-range-af806fb1-00069))_
- 35 
...
So what about const. Does it work the same way? _(javascriptallonge.pdf (source-range-af806fb1-00070))_
- 36 
...
((diameter) => { **const** PI = 3; **if** ( **true** ) { **const** PI = 3.14159265; **return** diameter * PI; } })(2) _//=> 6.2831853_ ((diameter) => { **const** PI = 3.14159265; **if** ( **true** ) { **const** PI = 3; } **return** diameter * PI; _(javascriptallonge.pdf (source-range-af806fb1-00071))_
- The first sip: Basic Functions 
...
> 32https://en.wikipedia.org/wiki/Principle_of_least_privilege _(javascriptallonge.pdf (source-range-af806fb1-00072))_
- There are other ways to name things in JavaScript, but before we learn some of those, let’s see how to use what we already have to name things. _(javascriptallonge.pdf (source-range-af806fb1-00061))_
- > 29JavaScript programmers regularly use the idea of writing an expression that denotes a function and then immediately applying it to arguments. _(javascriptallonge.pdf (source-range-af806fb1-00062))_
- What would be very nice is if the language gave us a way to bind names inside of blocks without incurring the cost of a function invocation. _(javascriptallonge.pdf (source-range-af806fb1-00063))_
- This differs from our example above in that there is only one environment, rather than two. _(javascriptallonge.pdf (source-range-af806fb1-00064))_
- Up to now, we’ve only ever seen blocks we use as the body of functions. _(javascriptallonge.pdf (source-range-af806fb1-00066))_
- We’ve used a block as the else clause, and since it’s a block, we’ve placed a const statement inside it. _(javascriptallonge.pdf (source-range-af806fb1-00067))_
- This is called lexical scoping[31] , because we can discover where a name is bound by looking at the source code for the program. _(javascriptallonge.pdf (source-range-af806fb1-00068))_
- We know this from the chapter on closures, but even though PI is not bound when we invoke diameter_fn by evaluating diameter_fn(2), PI _is_ bound when we evaluated (diameter) => diameter * PI, and thus the expression diameter * PI is able to access values for PI and diameter when we evaluate diameter_fn. _(javascriptallonge.pdf (source-range-af806fb1-00068))_
- But const statements can appear inside blocks, and we saw that blocks can appear inside of other blocks, including function bodies. _(javascriptallonge.pdf (source-range-af806fb1-00069))_
- It has effect inside its own scope, but does not affect the binding in the enclosing scope. _(javascriptallonge.pdf (source-range-af806fb1-00070))_
- But const statements can appear inside blocks. _(javascriptallonge.pdf (source-range-af806fb1-00071))_
- Parameters are only bound when we invoke a function. _(javascriptallonge.pdf (source-range-af806fb1-00071))_
- If const always bound its value to the name defined in the function’s environment, placing a const statement inside of a block would merely rebind the existing name, overwriting its old contents. _(javascriptallonge.pdf (source-range-af806fb1-00072))_
