---
page_id: javascriptallonge-section-a-few-utilities-ed4649a9
page_kind: source
...
projection_coverage: section-javascriptallonge-section-a-few-utilities-ed4649a9@1805be006985a4498c41bd873471a9fb
---
...
- Our new at and set functions behave similarly to array[index] and array[index] = value . The main difference is that array[index] = value evaluates to value , while set(index, value, list) evaluates to the modified list . _(javascriptallonge.pdf (source-range-8eb13d6b-01236))_

## Technical atoms

### Technical frame 1: a few utilities

**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-01236))_
