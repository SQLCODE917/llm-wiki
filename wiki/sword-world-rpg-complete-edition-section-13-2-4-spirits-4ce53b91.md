...
- Armor is ineffective against this attack, and only adventurer level can reduce the damage. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-07108))_

## Technical atoms

### Technical frame 1: 13.2.4 Spirits

**Context:** _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-07108))_

> damage 2 . Armor is ineffective against this attack, and only adventurer level can reduce the damage.

**Atom:** _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-07109))_
