---
page_id: javascriptallonge-section-functions-that-evaluate-to-functions-04de18cd
page_kind: source
summary: **functions that evaluate to functions**: 6 source-backed entries and 1 atom(s) from raw/javascriptallonge.pdf.
