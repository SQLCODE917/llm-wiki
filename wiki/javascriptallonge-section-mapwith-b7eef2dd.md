---
page_id: javascriptallonge-section-mapwith-b7eef2dd
page_kind: source
...
projection_coverage: section-javascriptallonge-section-mapwith-b7eef2dd@860efb40115a68ef5643ecf89b0e7024
---
...
- That means that you can pass a function to mapWith and get back a function that applies that mapping to any array. For example, we might need a function to return the squares of an array. Instead of writing a a wrapper around .map : _(javascriptallonge.pdf (source-range-8eb13d6b-01436))_
