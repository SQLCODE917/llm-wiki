---
page_id: javascriptallonge-section-more-generators-59ed9e0a
page_kind: source
...
projection_coverage: section-javascriptallonge-section-more-generators-59ed9e0a@ed9189651effb8cdbfdcdd63a7b88745
---
...
- Our OneTwoThree example used implicit state to output the numbers in sequence. Recall that we wrote Fibonacci using explicit state: _(javascriptallonge.pdf (source-range-31a4cf47-01721))_
