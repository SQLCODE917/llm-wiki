...
- If this final score is greater than or equal to the target score originally set for that first magic that was cast, then that first magic can be nullified. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-02648))_
- Therefore, when an adventurer uses magic that has a target score , that player should note down that score and remember it. _(Sword World RPG - Complete Edition.pdf (source-range-0b9dec90-02649))_
