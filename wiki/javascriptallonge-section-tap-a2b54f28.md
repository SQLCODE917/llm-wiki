---
page_id: javascriptallonge-section-tap-a2b54f28
page_kind: source
...
projection_coverage: section-javascriptallonge-section-tap-a2b54f28@dc47bb01454aea2123c7705fd9c21f02
---
...
- It has some surprising applications. One is when you want to do something with a value for sideeffects, but keep the value around. Behold: _(javascriptallonge.pdf (source-range-31a4cf47-00685))_
- tap is a traditional name borrowed from various Unix shell commands. It takes a value and returns a function that always returns the value, but if you pass it a function, it executes the function for side-effects. Let's see it in action as a poor-man's debugger: _(javascriptallonge.pdf (source-range-31a4cf47-00687))_
- p.s. tap can do more than just act as a debugging aid. It's also useful for working with object and instance methods. _(javascriptallonge.pdf (source-range-31a4cf47-00693))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-00687))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-00693))_
