---
page_id: javascriptallonge-section-how-to-run-the-examples-2a5f8086
page_kind: source
...
projection_coverage: section-javascriptallonge-section-how-to-run-the-examples-2a5f8086@71193e91b75be75bdcdba7c1e3e74ce3
---
...
> 100https://github.com/google/traceur-compiler 101http://babeljs.io/ _(javascriptallonge.pdf (source-range-af806fb1-00319))_
- The Golden Crema: Appendices and Afterwords 
...
> 103https://en.wikipedia.org/wiki/REPL _(javascriptallonge.pdf (source-range-af806fb1-00320))_
- Traceur and Babel are both _transpilers_ , they work by parsing ECMAScript 2015 code, then emitting valid ECMAScript-5 code that produces the same semantics. _(javascriptallonge.pdf (source-range-af806fb1-00319))_
