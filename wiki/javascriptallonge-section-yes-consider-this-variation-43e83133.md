---
page_id: javascriptallonge-section-yes-consider-this-variation-43e83133
page_kind: source
...
projection_coverage: section-javascriptallonge-section-yes-consider-this-variation-43e83133@ab88baeb0c2ce75748d012e48433fd7e
---
...
- What went wrong? Why didn't it give us 'Hello, Raganwald, my name is Friedrich'? The answer is that pesky var i . Remember that i is bound in the surrounding environment, so it's as if we wrote: _(javascriptallonge.pdf (source-range-8eb13d6b-01212))_
...
- Now we're creating a new inner parameter, i and binding it to the value of the outer i . This works, but let is so much simpler and cleaner that it was added to the language in the ECMAScript 2015 specification. _(javascriptallonge.pdf (source-range-8eb13d6b-01219))_
...
**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-01214))_
...
**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-01219))_
