---
page_id: javascriptallonge-section-if-functions-without-free-variables-are-pure-are-closures-impure-e2ee6411
page_kind: source
...
projection_coverage: section-javascriptallonge-section-if-functions-without-free-variables-are-pure-are-closures-impure-e2ee6411@6814b6d8cc4214b93983d290a40ef9b5
---
...
- If pure functions can contain closures, can a closure contain a pure function? Using only what we've learned so far, attempt to compose a closure that contains a pure function. If you can't, give your reasoning for why it's impossible. _(javascriptallonge.pdf (source-range-31a4cf47-00354))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-00354))_
