---
page_id: javascriptallonge-section-say-please-37506518
page_kind: source
...
projection_coverage: section-javascriptallonge-section-say-please-37506518@1f2de4b8722d861c560e2ed2a31c748a
---
...
- We can reverse this: Instead of asking a pair if it is empty and then deciding what to do, we can ask the pair to do it for us. Here's length again: _(javascriptallonge.pdf (source-range-31a4cf47-01390))_
- Now we'll need to write first and rest functions for a list, and those names will collide with the first and rest we wrote for pairs. So let's disambiguate our names: _(javascriptallonge.pdf (source-range-31a4cf47-01394))_
- We can write reverse and mapWith as well. We aren't being super-strict about emulating combinatory logic, we'll use default parameters: _(javascriptallonge.pdf (source-range-31a4cf47-01397))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-01399))_
