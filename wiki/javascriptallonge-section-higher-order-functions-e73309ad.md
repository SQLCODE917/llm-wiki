---
page_id: javascriptallonge-section-higher-order-functions-e73309ad
page_kind: source
...
projection_coverage: section-javascriptallonge-section-higher-order-functions-e73309ad@3d659bad79d0782ba6945f68b53aaf79
---
...
- In this book, we will be using a looser definition of 'combinator:' Higher-order pure functions that take only functions as arguments and return a function. We won't be strict about using only previously defined combinators in their construction. _(javascriptallonge.pdf (source-range-8eb13d6b-00565))_
