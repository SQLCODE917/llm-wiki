---
page_id: sword-world-rpg-complete-edition-section-2-enemy-strike-rolls-can-no-longer-critical-b4b634d3
page_kind: source
summary: [ 2. Enemy strike rolls can no longer critical ]: 11 source-backed entries and 2 atom(s) from raw/Sword World RPG - Complete Edition.pdf.
...
### Technical frame 1: [ 2. Enemy strike rolls can no longer critical ]
...
### Technical frame 2: [ 2. Enemy strike rolls can no longer critical ]
