...
Ptee - The author of the guide, a Finnish player with significant experience in AoE2.
Barbarian AI - An opponent used for practice in the early stages of improvement.
Twitch - A streaming platform used by the author for sharing gameplay.
Google Docs - A document format used by the author for creating guides.

## Procedures

Creating villagers - This involves using the appropriate actions and controls to generate villagers.
Building placement - This involves strategic positioning of buildings for defense and resource management.
Scouting - This involves sending units to gather information about the enemy.
Economy upgrades - This involves improving resource gathering efficiency.
Continuous production - This involves maintaining a steady rate of resource and unit production.
Army usage - This involves using units effectively in combat.
Team coordination - This involves working with allies in team games.

## References

- Ptee build orders Google Docs link from the source: <https://docs.google.com/document/d/1h0ZGvSuNM_-jxLpBLp3GxsD3tF-_AR_tC4-MdSAkrIY/edit?usp=sharing>
- AoE2 DE villagers-required calculator for resource income planning: <https://aoe2-de-tools.herokuapp.com/villagers-required/>

## Open questions

1. What are the specific timing strategies for different map types?
2. How does unit counter interaction change with different civilizations?
3. What are the best practices for managing resources during the early game?
4. How do different team compositions affect gameplay?
5. What are the optimal build orders for specific situations?
...
| AoE2 Military Upgrades | [../references/aoe2-military-upgrades.md](../references/aoe2-military-upgrades.md) | Common edges | should create | archer-to-crossbow timing, bodkin, knight armor upgrades, damage reduction, and longsword tech | created |
| AoE2 Scouting Techniques | [../procedures/aoe2-scouting-techniques.md](../procedures/aoe2-scouting-techniques.md) | Foundation | should create | scouting enemy openings, army movement, and resource exposure | created |
