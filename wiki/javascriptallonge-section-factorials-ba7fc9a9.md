---
page_id: javascriptallonge-section-factorials-ba7fc9a9
page_kind: source
...
projection_coverage: section-javascriptallonge-section-factorials-ba7fc9a9@c4bded5bde9bc26fc62b05e12fe9924c
---
...
- In mathematics, the factorial of a non-negative integer n , denoted by n! , is the product of all positive integers less than or equal to n . For example: _(javascriptallonge.pdf (source-range-31a4cf47-00989))_
...
- Once again, it is not tail-recursive, it needs to save the stack with each invocation so that it can take the result returned and compute n * factorial(n -1) . We can do the same conversion, pass in the work to be done: _(javascriptallonge.pdf (source-range-31a4cf47-00994))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-00999))_
