---
page_id: javascriptallonge-section-why-const-and-let-were-invented-5a03ee4b
page_kind: source
...
projection_coverage: section-javascriptallonge-section-why-const-and-let-were-invented-5a03ee4b@648ea5641729fdc8c492a80af3bdab63
---
...
- We haven't looked at it yet, but JavaScript provides a for loop for your iterating pleasure and convenience. It looks a lot like the for loop in C. Here it is with var : _(javascriptallonge.pdf (source-range-8eb13d6b-01202))_
- Hopefully, you can think of a faster way to calculate this sum. 72 And perhaps you have noticed that var i = 1 is tucked away instead of being at the top as we prefer. But is this ever a problem? _(javascriptallonge.pdf (source-range-8eb13d6b-01204))_
