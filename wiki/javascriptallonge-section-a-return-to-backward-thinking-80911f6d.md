---
page_id: javascriptallonge-section-a-return-to-backward-thinking-80911f6d
page_kind: source
...
projection_coverage: section-javascriptallonge-section-a-return-to-backward-thinking-80911f6d@81c95bbfd914373d233387aabb6a4448
---
...
- To make pairs work, we did things backwards , we passed the first and rest functions to the pair, and the pair called our function. As it happened, the pair was composed by the vireo (or V combinator): (x) => (y) => (z) => z(x)(y) . _(javascriptallonge.pdf (source-range-8eb13d6b-01408))_
- But we could have done something completely different. We could have written a pair that stored its elements in an array, or a pair that stored its elements in a POJO. All we know is that we can pass the pair function a function of our own, at it will be called with the elements of the pair. _(javascriptallonge.pdf (source-range-8eb13d6b-01409))_
- The exact implementation of a pair is hidden from the code that uses a pair. Here, we'll prove it: _(javascriptallonge.pdf (source-range-8eb13d6b-01410))_
...
**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-01412))_
