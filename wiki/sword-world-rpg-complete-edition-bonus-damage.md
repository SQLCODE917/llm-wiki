...
page_kind: concept
summary: 【 Bonus Damage 】: 58 statement(s) and 5 atom(s) from raw/Sword World RPG - Complete Edition.pdf.
sources: raw/Sword World RPG - Complete Edition.pdf
updated: 2026-06-28
domain: sword-world-rpg-complete-edition
category_path: concepts
projection_coverage: topic-sword-world-rpg-complete-edition-bonus-damage@f82a07b012dd435ffc967acf890c8eaf
---
...
- Once you've determined base damage, you must then add your character's bonus damage. This will be the total amount of damage the character deals the monster. _(Sword World RPG - Complete Edition.pdf (source-range-de1806a5-00856))_
...
- Add the attacker's bonus damage to the result in 1. _(Sword World RPG - Complete Edition.pdf (source-range-de1806a5-09005))_
...
### Technical frame 1: 【 Bonus Damage 】

**Context:** _(Sword World RPG - Complete Edition.pdf (source-range-de1806a5-00785))_

> If fighter (or thief, ranger) skill level is 0 , bonus damage is 0 regardless of the character's strength bonus.

**Atom:** _(Sword World RPG - Complete Edition.pdf (source-range-de1806a5-00782))_

> These characters can deal more damage to their foes, even when using the same sized weapon.

### Technical frame 2: 【 Bonus Damage 】

**Context:** _(Sword World RPG - Complete Edition.pdf (source-range-de1806a5-00785))_

> If fighter (or thief, ranger) skill level is 0 , bonus damage is 0 regardless of the character's strength bonus.

**Atom:** _(Sword World RPG - Complete Edition.pdf (source-range-de1806a5-00784))_

> bonus damage = fighter (thief/ranger) skill level + strength bonus

### Technical frame 3: 4.5.3 Bonus Damage

**Atom:** _(Sword World RPG - Complete Edition.pdf (source-range-de1806a5-00856))_

> Once you've determined base damage, you must then add your character's bonus damage.

### Technical frame 4: [ Ash ] Monster Level=2 Rarity=11 Agility=9 Movement Speed=8 Number=Several Frequency=Moderate Intellect=Almost none Reaction=Violent Attack Points=- Strike Points=Evasion Points=- Defense Points=Life Points/Resistance=7/9 (2) Mental Points/Resistance=-/10 (3) Special Abilities=Wrap (Evasion target score=10, strike power 10, bonus damage 2) Mental attack immunity Weapon immunity Fire immunity Not affected by poison and illness Damage from healing magic Habitat=Ruins Languages=None Perception=Magic
...
- [[sword-world-rpg-complete-edition-bonus]] - broader topic: Bonus shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction . (10 shared statement(s))
- [[sword-world-rpg-complete-edition-fail]] - shared statements and technical atoms: Fail shares source evidence from [ Dark Elf ]: They are apostles of the dark gods, and love to be despicable. Assassination using Invisibility is said to be their most special technique. The weapons they use are ... [truncated]; Fail shares technical record from [ Ash ] Monster Level=2 Rarity=11 Agility=9 Movement Speed=8 Number=Several Frequency=Moderate Intellect=Almost none Reaction=Violent Attack Points=- Strike Points=Evasion Points=- Defense Points=Life Points/Resistance=7/9 (2) Mental Points/Resistance=-/10 (3) Special Abilities=Wrap (Evasion target score=10, strike power 10, bonus damage 2) Mental attack immunity Weapon immunity Fire immunity Not affected by poison and illness Damage from healing magic Habitat=Ruins Languages=None Perception=Magic: If you cast the spirit magic Missile Protection , you can protect yourself from being enwrapped by the ash. (5 shared statement(s), 1 shared atom(s))
- [[sword-world-rpg-complete-edition-result]] - shared statements and technical atoms: Result shares source evidence from [ Will-O-Wisp ]: The other type is one that collides directly with anything that comes into view. Will-o-wisps only target things that have a functioning mind. They will not target p ... [truncated]; Result shares technical table: Table 5-10: Requiem around the bard. It takes about 18 rounds 2D  Result to gather. If the summoned  small (3 shared statement(s), 1 shared atom(s))
- [[sword-world-rpg-complete-edition-table]] - shared statements and technical atoms: Table shares source evidence from [ 2. Enemy strike rolls can no longer critical ]: For strike points , apply strike power to Table 13-1: Key Number = Expected Equivalents , then add bonus damage to the result. Critical target is normally 10,; Table shares technical table: Table 5-10: Requiem around the bard. It takes about 18 rounds 2D  Result to gather. If the summoned  small (1 shared statement(s), 1 shared atom(s))
- [[sword-world-rpg-complete-edition-round]] - shared technical atoms: Round shares technical record from [ Ash ] Monster Level=2 Rarity=11 Agility=9 Movement Speed=8 Number=Several Frequency=Moderate Intellect=Almost none Reaction=Violent Attack Points=- Strike Points=Evasion Points=- Defense Points=Life Points/Resistance=7/9 (2) Mental Points/Resistance=-/10 (3) Special Abilities=Wrap (Evasion target score=10, strike power 10, bonus damage 2) Mental attack immunity Weapon immunity Fire immunity Not affected by poison and illness Damage from healing magic Habitat=Ruins Languages=None Perception=Magic: Table 5-10: Requiem around the bard. It takes about 18 rounds 2D  Result to gather. If the summoned  small (2 shared atom(s))
- [[sword-world-rpg-complete-edition-power]] - shared statements: Power shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction . (14 shared statement(s))
- [[sword-world-rpg-complete-edition-strike]] - shared statements: Strike shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction . (9 shared statement(s))
- [[sword-world-rpg-complete-edition-fire]] - shared statements: Fire shares source evidence from Chapter 11: Notes on Magic / [ Fire Breath ]: The caster breathes fire from their mouth like a dragon. The fire's area of effect is a semicircle with a 10 meter forward radius. The fire's strike power is 20, and ... [truncated] (5 shared statement(s))
- [[sword-world-rpg-complete-edition-rarity]] - shared statements: Rarity shares source evidence from [ Wyvern ]: Monster Level=7 Rarity=10 Agility=18 Movement Speed=8/35 (air) Number=One Frequency=Rare Intellect=Animal Reaction=Neutral Attack Points=Fangs:14 (7)/Talon:15 (8)/ T ... [truncated] (5 shared statement(s))
- [[sword-world-rpg-complete-edition-level]] - shared statements: Level shares source evidence from 【 Bonus Damage 】: If fighter (or thief, ranger) skill level is 0 , bonus damage is 0 regardless of the character's strength bonus. (4 shared statement(s))
- [[sword-world-rpg-complete-edition-ranger-skill]] - shared statements: 【 Ranger Skill 】 shares source evidence from 【 Bonus Damage 】: If fighter (or thief, ranger) skill level is 0 , bonus damage is 0 regardless of the character's strength bonus. (4 shared statement(s))
- [[sword-world-rpg-complete-edition-skill]] - shared statements: Skill shares source evidence from 【 Bonus Damage 】: If fighter (or thief, ranger) skill level is 0 , bonus damage is 0 regardless of the character's strength bonus. (4 shared statement(s))
...
- [[sword-world-rpg-complete-edition-meter]] - shared statements: Meter shares source evidence from Elder Dragon: Elder dragons also have the ability to breathe fire. Elder-species' fire spreads in a 30-meter forward radius, and those who fail a mental power resistance roll agai ... [truncated] (3 shared statement(s))
- [[sword-world-rpg-complete-edition-range]] - shared statements: Range shares source evidence from 【 Bonus Damage 】: If fighter (or thief, ranger) skill level is 0 , bonus damage is 0 regardless of the character's strength bonus. (3 shared statement(s))
- [[sword-world-rpg-complete-edition-character]] - shared statements: Character shares source evidence from 【 Bonus Damage 】: Characters with deep experience in combat can handle weapons effectively. In addition, characters with high strength can wield weapons more powerfully. These charact ... [truncated] (2 shared statement(s))
...
- [[sword-world-rpg-complete-edition-evasion]] - shared statements: Evasion shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction . (2 shared statement(s))
...
- [[sword-world-rpg-complete-edition-resist]] - shared statements: Resist shares source evidence from Elder Dragon: Elder dragons also have the ability to breathe fire. Elder-species' fire spreads in a 30-meter forward radius, and those who fail a mental power resistance roll agai ... [truncated] (2 shared statement(s))
- [[sword-world-rpg-complete-edition-addition]] - shared statements: Addition shares source evidence from 【 Bonus Damage 】: Characters with deep experience in combat can handle weapons effectively. In addition, characters with high strength can wield weapons more powerfully. These charact ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-adventure]] - shared statements: Adventure shares source evidence from Chapter 16: / Projectile Bonus Damage: In the basic rules, any weapon's bonus damage equals fi ghter (or thief, ranger) skill level + strength bonus , but for projectiles , an adventurer's strength is not ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-adventurer]] - shared statements: Adventurer shares source evidence from Chapter 16: / Projectile Bonus Damage: In the basic rules, any weapon's bonus damage equals fi ghter (or thief, ranger) skill level + strength bonus , but for projectiles , an adventurer's strength is not ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-agility]] - shared statements: Agility shares source evidence from [ Wyvern ]: Monster Level=7 Rarity=10 Agility=18 Movement Speed=8/35 (air) Number=One Frequency=Rare Intellect=Animal Reaction=Neutral Attack Points=Fangs:14 (7)/Talon:15 (8)/ T ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-base]] - shared statements: Base shares source evidence from Determining Base Damage (Strike Roll): Damage calculation takes three steps: ① Determine base damage , ② Add bonus damage , and ③ Subtract the monster's defense points . (1 shared statement(s))
- [[sword-world-rpg-complete-edition-body]] - shared statements: Body shares source evidence from Gizmo: Even if a gizmo's attack hits, it does not deal damage by itself. However, the body of a gizmo is poisonous gas, so those hit by it will inhale it and suffer damage ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-cast]] - shared statements: Cast shares source evidence from 《 Damage 》: In either case, the caster's magic power can be added as bonus damage to the result of the strike roll. Also, the target's adventurer level (or the monster's monster ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-caster]] - shared statements: Caster shares source evidence from 《 Damage 》: In either case, the caster's magic power can be added as bonus damage to the result of the strike roll. Also, the target's adventurer level (or the monster's monster ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-check]] - shared statements: Check shares source evidence from 《 Strong to Fire 》: Resistant to fire attacks, so for magic that deals damage with fire ( Fire Bolt and Fireball ), checks are made at -10 to strike power (the strike power bonus of Fir ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-effect]] - shared statements: Effect shares source evidence from Chapter 12: Various Checks / [Dark Blade (Injected/Damage)]: Effect=Become disabled, and suffer strike power 20 damage plus bonus damage 6 every 10 minutes. Resist negates effect Toxicity Score=15 Rarity=10 Effect Start Time= ... [truncated] (1 shared statement(s))
...
- [[sword-world-rpg-complete-edition-magical]] - shared statements: Magical shares source evidence from 【 Magical Weapons 】: Magical weapons have exceptional attack power and bonus damage . If you use a +1 magical weapon, you receive a +1 bonus to attack power and bonus damage. If +2, thos ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-master]] - shared statements: Master shares source evidence from Chapter 14: / 《 Undead Ruler 》: Rarity=18 Enchanter=Jagrilis, "The Master of Death" Form=Mage's staff engraved with ancient runes Required Strength=5 (Strike power 10) Base Trade Price=400,000 game ... [truncated] (1 shared statement(s))
...
- [[sword-world-rpg-complete-edition-move]] - shared statements: Move shares source evidence from [ Wyvern ]: Monster Level=7 Rarity=10 Agility=18 Movement Speed=8/35 (air) Number=One Frequency=Rare Intellect=Animal Reaction=Neutral Attack Points=Fangs:14 (7)/Talon:15 (8)/ T ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-movement]] - shared statements: Movement shares source evidence from [ Wyvern ]: Monster Level=7 Rarity=10 Agility=18 Movement Speed=8/35 (air) Number=One Frequency=Rare Intellect=Animal Reaction=Neutral Attack Points=Fangs:14 (7)/Talon:15 (8)/ T ... [truncated] (1 shared statement(s))
- [[sword-world-rpg-complete-edition-score]] - shared statements: Score shares source evidence from Ragnakang: Poison (toxicity score 13, strike power 20, bonus damage 6) Habitat=Underground labyrinths, secluded ruins (1 shared statement(s))
- [[sword-world-rpg-complete-edition-target]] - shared statements: Target shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction . (1 shared statement(s))
...
- [[sword-world-rpg-complete-edition-section-bonus-damage-ba5bac46]] - source section: 【 Bonus Damage 】 shares source evidence from 【 Bonus Damage 】: Characters with deep experience in combat can handle weapons effectively. In addition, characters with high strength can wield weapons more powerfully. These charact ... [truncated]; 【 Bonus Damage 】 shares technical record from 【 Bonus Damage 】: These characters can deal more damage to their foes, even when using the same sized weapon. (4 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-section-4-5-3-bonus-damage-8d90d126]] - source section: 4.5.3 Bonus Damage shares source evidence from 4.5.3 Bonus Damage: Once you've determined base damage, you must then add your character's bonus damage. This will be the total amount of damage the character deals the monster.; 4.5.3 Bonus Damage shares technical record from 4.5.3 Bonus Damage: Once you've determined base damage, you must then add your character's bonus damage. (1 shared statement(s), 2 shared atom(s))
