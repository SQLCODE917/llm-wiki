---
page_id: javascriptallonge-section-that-constant-coffee-craving-5ec1ad3b
page_kind: source
...
projection_coverage: section-javascriptallonge-section-that-constant-coffee-craving-5ec1ad3b@92966df5d0f763f116d4dadc7eb013f2
---
...
- In order to bind 3.14159265 to the name PI , we'll need a function with a parameter of PI applied to an argument of 3.14159265 . If we put our function expression in parentheses, we can apply it to the argument of 3.14159265 : _(javascriptallonge.pdf (source-range-31a4cf47-00391))_
...
- That works! We can bind anything we want in an expression by wrapping it in a function that is immediately invoked with the value we want to bind. 29 _(javascriptallonge.pdf (source-range-31a4cf47-00399))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-00399))_
