---
page_id: javascriptallonge-section-default-arguments-a85d3baf
page_kind: source
...
projection_coverage: section-javascriptallonge-section-default-arguments-a85d3baf@8bb19bc19b227a9896de0c2810a62b68
---
...
- What we really want is this: We want to write something like factorial(6) , and have JavaScript automatically know that we really mean factorial(6, 1) . But when it calls itself, it will call factorial(5, 6) and that will not mean factorial(5, 1) . _(javascriptallonge.pdf (source-range-31a4cf47-01004))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-01004))_
