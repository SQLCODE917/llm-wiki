---
page_id: javascriptallonge-section-bonus-02231193
page_kind: source
...
projection_coverage: section-javascriptallonge-section-bonus-02231193@c3b0d3066baa76e0c565dfe92ab2a4da
---
...
- This is interesting, because it is lazy: It doesn't apply fn to every element in an iteration, just enough to find the first that passes the test. Whereas if we wrote something like: _(javascriptallonge.pdf (source-range-31a4cf47-01319))_
...
**Context:** _(javascriptallonge.pdf (source-range-31a4cf47-01321))_
