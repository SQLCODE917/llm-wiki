---
page_id: javascriptallonge-section-iterating-b85cef64
page_kind: source
...
projection_coverage: section-javascriptallonge-section-iterating-b85cef64@ebf00cead19ed2674b87a4cd99dfab6a
---
...
- Notice that buried inside our loop, we have bound the names done and value . We can put those into a POJO (a Plain Old JavaScript Object). It'll be a little awkward, but we'll be patient: _(javascriptallonge.pdf (source-range-31a4cf47-01291))_
...
- We can write a different iterator for a different data structure. Here's one for linked lists: _(javascriptallonge.pdf (source-range-31a4cf47-01295))_
