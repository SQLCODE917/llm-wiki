---
page_id: javascriptallonge-section-const-and-lexical-scope-5a865c0d
page_kind: source
...
projection_coverage: section-javascriptallonge-section-const-and-lexical-scope-5a865c0d@8ce9346ba374160d54a918eddb4a71b6
---
...
- It's more than a bit convoluted, but it binds ((PI) => (diameter) => diameter * PI)(3.14159265) to diameter_fn and evaluates the expression that we've elided. We can use any expression in there, and that expression can invoke diameter_fn . For example: _(javascriptallonge.pdf (source-range-8eb13d6b-00455))_
...
- That much we can carefully work out from the way closures work. Does const work the same way? Let's find out: _(javascriptallonge.pdf (source-range-8eb13d6b-00462))_
...
**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-00455))_
...
**Context:** _(javascriptallonge.pdf (source-range-8eb13d6b-00461))_
