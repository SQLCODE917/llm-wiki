...
- **Shaman**: A character who can summon and recognize spirits.
- **Mad Spirits**: Spirits that appear in the material world and act destructively.
- **Spirit Magic**: Magic that can be used by spirits, which does not consume mental points.

## Key Concepts

- **Spirit Power**: The power that spirits possess, which they can use unlimitedly without consuming mental points.
- **Spirit World**: The world where spirits normally reside, distinct from the material world.
- **Material World**: The world where humans and other creatures live, where spirits may appear.
- **Rarity**: A score related to how well-known the monster is, which affects recognition by shamans.
