...
page_kind: source
summary: Claim-ledger projection (coding): 1989 usable entries, 654 technical atoms, 427 needs-review, 301 linked page(s); write decision write-with-review-work.
sources: raw/javascriptallonge.pdf
updated: 2026-06-29
domain: javascriptallonge
category_path: sources
source_id: javascriptallonge.pdf
projection_coverage: projection-coverage-8aade5cd50447e0b@c71b3cbe56e563c9
---
...
**Atom:** _(javascriptallonge.pdf (source-range-7239e085-00005))_

> This version was published on 2017-11-03

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-00006))_

> [Figure] (p.2)

## A Pull of the Lever: Prefaces

- Some complain that the long pull is more bitter and detracts from the best character of the coffee, others feel it releases even more complexity. _(javascriptallonge.pdf (source-range-7239e085-00013))_

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-00010))_

> [Figure] (p.6)

#### About JavaScript Allongé

- JavaScript Allongé is a first and foremost, a book about programming with functions . _(javascriptallonge.pdf (source-range-7239e085-00016))_
- It's written in JavaScript, because JavaScript hits the perfect sweet spot of being both widely used, and of having proper first-class functions with lexical scope. _(javascriptallonge.pdf (source-range-7239e085-00016))_
- It's written in JavaScript, because JavaScript hits the perfect sweet spot of being both widely used, and of having proper first-class functions with lexical scope. _(javascriptallonge.pdf (source-range-7239e085-00016))_
...
- It also provides recipes for using functions to write software that is simpler, cleaner, and less complicated than alternative approaches that are object-centric or code-centric. _(javascriptallonge.pdf (source-range-7239e085-00018))_
- JavaScript idioms like function combinators and decorators leverage JavaScript's power to make code easier to read, modify, debug and refactor. _(javascriptallonge.pdf (source-range-7239e085-00018))_
...
- Features like destructuring, block-structured variables, iterables, generators, and the class keyword are poised to make JavaScript programming more expressive. _(javascriptallonge.pdf (source-range-7239e085-00021))_
- ECMAScript 2015 (formerly called ECMAScript 6 or 'ES6'), is ushering in a very large number of improvements to the way programmers can write small, powerful components and combine them into larger, fully featured programs. _(javascriptallonge.pdf (source-range-7239e085-00021))_
- Over time, programmers discovered ways to roll their own versions of important features. _(javascriptallonge.pdf (source-range-7239e085-00022))_
...
- And the variable i is scoped locally to the code within the braces. _(javascriptallonge.pdf (source-range-7239e085-00025))_
- Prior to ECMAScript 2015, JavaScript did not support block-structuring, so programmers borrowed a trick from the Scheme programming language, and would write: _(javascriptallonge.pdf (source-range-7239e085-00025))_
- Likewise, many programming languages permit functions to have a variable number of arguments, and to collect the arguments into a single variable as an array. _(javascriptallonge.pdf (source-range-7239e085-00028))_
...
- But now, JavaScript is gaining many important features, in part because the governing body behind JavaScript has observed that programmers are constantly working around the same set of limitations. _(javascriptallonge.pdf (source-range-7239e085-00034))_
- And i is scoped to the for loop. _(javascriptallonge.pdf (source-range-7239e085-00036))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00023))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00034))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00036, source-range-7239e085-00038))_
...
- It would have continued to say much the same things, only with new syntax. _(javascriptallonge.pdf (source-range-7239e085-00042))_
- If it were just a matter of updating the syntax, the original version of JavaScript Allongé could have simply iterated, slowly replacing old syntax with new. _(javascriptallonge.pdf (source-range-7239e085-00042))_
- It would have continued to say much the same things, only with new syntax. _(javascriptallonge.pdf (source-range-7239e085-00042))_
- The original JavaScript Allongé was not just written to teach JavaScript: It was written to describe certain ideas in programming: Working with small, independent entities that compose together to make bigger programs. _(javascriptallonge.pdf (source-range-7239e085-00043))_
- As noted above, JavaScript was chosen as the language for Allongé because it hit a sweet spot of having a large audience of programmers and having certain language features that happen to work well with this style of programming. _(javascriptallonge.pdf (source-range-7239e085-00044))_
- As noted above, JavaScript was chosen as the language for Allongé because it hit a sweet spot of having a large audience of programmers and having certain language features that happen to work well with this style of programming. _(javascriptallonge.pdf (source-range-7239e085-00044))_
- It makes a number of interesting programming techniques easy to explain and easy to use. _(javascriptallonge.pdf (source-range-7239e085-00045))_
- ECMAScript 2015 does more than simply update the language with some simpler syntax for a few things and help us avoid warts. _(javascriptallonge.pdf (source-range-7239e085-00045))_
- But the common thread that runs through all these things is that since they are all simple objects and simple functions, we can use the same set of 'programming with functions' techniques to build programs by composing small, flexible, and decoupled entities. _(javascriptallonge.pdf (source-range-7239e085-00046))_
- But even so, in a way it is still explaining the exact same original idea that programs are built out of small, flexible functions composed together. _(javascriptallonge.pdf (source-range-7239e085-00048))_
- And introducing these new ideas did add substantially to its bulk. _(javascriptallonge.pdf (source-range-7239e085-00048))_
- Introducing so many new ideas did require a major rethink of the way the book was organized. _(javascriptallonge.pdf (source-range-7239e085-00048))_

#### What JavaScript Allongé is. And isn't.

- JavaScript Allongé is a book about programming with functions. _(javascriptallonge.pdf (source-range-7239e085-00052))_
- The focus in this book on the underlying ideas, what we might call the fundamentals, and how they combine to form new ideas. _(javascriptallonge.pdf (source-range-7239e085-00053))_
- The intention is to improve the way we think about programs. _(javascriptallonge.pdf (source-range-7239e085-00053))_
...
- But while JavaScript Allongé attempts to be provocative, it is not prescriptive . _(javascriptallonge.pdf (source-range-7239e085-00054))_
- There is absolutely no suggestion that any of the techniques shown here are the only way to do something, the best way, or even an acceptable way to write programs that are intended to be used, read, and maintained by others. _(javascriptallonge.pdf (source-range-7239e085-00054))_
- Choices in development are often driven by social considerations. _(javascriptallonge.pdf (source-range-7239e085-00055))_
- Software development is a complex field. _(javascriptallonge.pdf (source-range-7239e085-00055))_
- People often say that software should be written for people to read. _(javascriptallonge.pdf (source-range-7239e085-00055))_
- Choices in software development are also often driven by requirements specific to the type of software being developed. _(javascriptallonge.pdf (source-range-7239e085-00056))_
...
- For example, business software written in-house has a very different set of requirements than a library written to be publicly distributed as open-source. _(javascriptallonge.pdf (source-range-7239e085-00056))_
- If a particular codebase is written with lots of helper functions that place the subject first, like this: _(javascriptallonge.pdf (source-range-7239e085-00057))_
- Choices in software development must also consider the question of consistency. _(javascriptallonge.pdf (source-range-7239e085-00057))_
...
- Then it can be jarring to add new helpers written that place the verb first, like this: _(javascriptallonge.pdf (source-range-7239e085-00059))_
- Continuous integration encourages the creation of software in tandem with and factored to facilitate the creation of automated test suites. _(javascriptallonge.pdf (source-range-7239e085-00062))_
- Finally, choices in software development cannot ignore the tooling that is used to create and maintain software. _(javascriptallonge.pdf (source-range-7239e085-00062))_
- Debuggers encourage the use of functions with explicit or implicit names. _(javascriptallonge.pdf (source-range-7239e085-00062))_
- The use of source-code control systems with integrated diffing rewards making certain types of focused changes. _(javascriptallonge.pdf (source-range-7239e085-00062))_
- The use of linters 1 makes checking for certain types of undesirable code very cheap. _(javascriptallonge.pdf (source-range-7239e085-00062))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00057))_
...
- Code examples within each chapter are small and emphasize exposition rather than serving as patterns for everyday use. _(javascriptallonge.pdf (source-range-7239e085-00065))_
- While the content of each chapter builds naturally on what was discussed in the previous chapter, the recipes may draw upon any aspect of the JavaScript programming language. _(javascriptallonge.pdf (source-range-7239e085-00067))_
- Following some of the chapters are a series of recipes designed to show the application of the chapter's ideas in practical form. _(javascriptallonge.pdf (source-range-7239e085-00067))_

#### Foreword to the 'Six' edition

- That version was planned to have numerous new features (interfaces, namespaces, packages, multimethods, etc.), which would have turned JavaScript into a completely new language. _(javascriptallonge.pdf (source-range-7239e085-00069))_
- Getting there took a while - in a way, the origins of ES6 date back to the year 2000: After ECMAScript 3 was finished, TC39 (the committee evolving JavaScript) started to work on ECMAScript 4. _(javascriptallonge.pdf (source-range-7239e085-00069))_
- ECMAScript 6 (short name: ES6; official name: ECMAScript 2015) was ratified as a standard on June 17. _(javascriptallonge.pdf (source-range-7239e085-00069))_
- After internal conflict, a settlement was reached in July 2008 and a new plan was made - to abandon ECMAScript 4 and to replace it with two upgrades: _(javascriptallonge.pdf (source-range-7239e085-00069))_
- After internal conflict, a settlement was reached in July 2008 and a new plan was made - to abandon ECMAScript 4 and to replace it with two upgrades: _(javascriptallonge.pdf (source-range-7239e085-00069))_
- Getting there took a while - in a way, the origins of ES6 date back to the year 2000: After ECMAScript 3 was finished, TC39 (the committee evolving JavaScript) started to work on ECMAScript 4. _(javascriptallonge.pdf (source-range-7239e085-00069))_
- - A smaller upgrade would bring a few minor enhancements to ECMAScript 3. _(javascriptallonge.pdf (source-range-7239e085-00070))_
- - A larger upgrade would substantially improve JavaScript, but without being as radical as ECMAScript 4. _(javascriptallonge.pdf (source-range-7239e085-00071))_
- This upgrade became ECMAScript 6 (some features that were initially discussed will show up later, in upcoming ECMAScript versions). _(javascriptallonge.pdf (source-range-7239e085-00071))_

## ECMAScript 6 has three major groups of features:

- And you'll do so via ES6 code, handed to you in small, easily digestible pieces. _(javascriptallonge.pdf (source-range-7239e085-00079))_
- You will learn much about functional programming and object-oriented programming. _(javascriptallonge.pdf (source-range-7239e085-00079))_
- JavaScript Allongé, the 'Six' Edition is both a comprehensive tour of its features and a rich collection of techniques for making better use of them. _(javascriptallonge.pdf (source-range-7239e085-00079))_
- With ECMAScript 6, JavaScript has become much larger as a language. _(javascriptallonge.pdf (source-range-7239e085-00079))_

#### Forewords to the First Edition

##### michael fogus

- As a life-long bibliophile and long-time follower of Reg's online work, I was excited when he started writing books. _(javascriptallonge.pdf (source-range-7239e085-00084))_
- Not only was this a great book, but it was also a great way to write and distribute books. _(javascriptallonge.pdf (source-range-7239e085-00084))_
- However, Reg sent me a copy of his book and I was humbled. _(javascriptallonge.pdf (source-range-7239e085-00084))_
- Not only was this a great book, but it was also a great way to write and distribute books. _(javascriptallonge.pdf (source-range-7239e085-00084))_
- The act of writing is an iterative process with (very often) tight revision loops. _(javascriptallonge.pdf (source-range-7239e085-00085))_
- However, the process of soliciting feedback, gathering responses, sending out copies, waiting for people to actually read it (if they ever do), receiving feedback and then ultimately making sense out of how to use it takes weeks and sometimes months. _(javascriptallonge.pdf (source-range-7239e085-00085))_
- On more than one occasion I've found myself attempting to reify feedback with content that either no longer existed or was changed beyond recognition. _(javascriptallonge.pdf (source-range-7239e085-00085))_
- However, the process of soliciting feedback, gathering responses, sending out copies, waiting for people to actually read it (if they ever do), receiving feedback and then ultimately making sense out of how to use it takes weeks and sometimes months. _(javascriptallonge.pdf (source-range-7239e085-00085))_
- Reg has crafted (and continues to craft) not only an interesting book from the perspective of a connoisseur, but also an entertaining exploration into some of the most interesting aspects of his art. _(javascriptallonge.pdf (source-range-7239e085-00086))_
- No matter how much of an expert you think you are, JavaScript Allongé has something to teach you… about coffee. _(javascriptallonge.pdf (source-range-7239e085-00086))_
- Reg has crafted (and continues to craft) not only an interesting book from the perspective of a connoisseur, but also an entertaining exploration into some of the most interesting aspects of his art. _(javascriptallonge.pdf (source-range-7239e085-00086))_
- While not exclusively a book about functional programming, JavaScript Allongé will provide a solid foundation for functional techniques. _(javascriptallonge.pdf (source-range-7239e085-00087))_
- As a staunch advocate of functional programming, much of what Reg has written rings true to me. _(javascriptallonge.pdf (source-range-7239e085-00087))_
- As an author of programming books I admire what Reg has managed to accomplish and I envy the fine reader who finds JavaScript Allongé via some darkened channel in the Internet sprawl and reads it for the first time. _(javascriptallonge.pdf (source-range-7239e085-00087))_
- However, you'll not be beaten about the head and neck with dogma. _(javascriptallonge.pdf (source-range-7239e085-00087))_
- Instead, every section is motivated by relevant dialog and fortified with compelling source examples. _(javascriptallonge.pdf (source-range-7239e085-00087))_

##### matthew knox

#### About The Sample PDF

- If you read JavaScript Allongé, The 'six' edition and it doesn't blow your mind, your money will be cheerfully refunded. _(javascriptallonge.pdf (source-range-7239e085-00093))_
- This sample edition of the book includes just a portion of the complete book. _(javascriptallonge.pdf (source-range-7239e085-00093))_
- No, this is not the author: But he has free coffee! _(javascriptallonge.pdf (source-range-7239e085-00097))_

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-00096))_
...
- All values are expressions. _(javascriptallonge.pdf (source-range-7239e085-00107))_
...
- Astute readers will realize we're omitting something. _(javascriptallonge.pdf (source-range-7239e085-00108))_
- So, boiling water plus ground coffee is an expression, but it isn't a value. _(javascriptallonge.pdf (source-range-7239e085-00109))_
- 11 Boiling water is a value. _(javascriptallonge.pdf (source-range-7239e085-00109))_
- Ground coffee is a value. _(javascriptallonge.pdf (source-range-7239e085-00109))_
- Boiling water plus ground coffee is an expression. _(javascriptallonge.pdf (source-range-7239e085-00109))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00102))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00105))_
...
- One is a demitasse, the other a mug. _(javascriptallonge.pdf (source-range-7239e085-00118))_
- For example, the string "2" is not the same thing as the number 2 . _(javascriptallonge.pdf (source-range-7239e085-00118))_
- First, sometimes, the cups are of different kinds. _(javascriptallonge.pdf (source-range-7239e085-00118))_
- This corresponds to comparing two things in JavaScript that have different types . _(javascriptallonge.pdf (source-range-7239e085-00118))_
- For example, the string "2" is not the same thing as the number 2 . _(javascriptallonge.pdf (source-range-7239e085-00118))_
...
- One holds a single, one a double. _(javascriptallonge.pdf (source-range-7239e085-00120))_
- This corresponds to comparing two JavaScript values that have the same type but different 'content.' For example, the number 5 is not the same thing as the number 2 . _(javascriptallonge.pdf (source-range-7239e085-00120))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00115))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00132))_
...
- In computer science, a literal is a notation for representing a fixed value in source code. _(javascriptallonge.pdf (source-range-7239e085-00141))_
- Almost all programming languages have notations for atomic values such as integers, floating-point numbers, and strings, and usually for booleans and characters; some also have notations for elements of enumerated types and compound values such as arrays, records, and objects. _(javascriptallonge.pdf (source-range-7239e085-00141))_
- If we start a literal with a zero, it is an octal literal. _(javascriptallonge.pdf (source-range-7239e085-00142))_
- Not all numbers are base ten. _(javascriptallonge.pdf (source-range-7239e085-00142))_
- It represents the number forty-two, which is 42 base 10. _(javascriptallonge.pdf (source-range-7239e085-00142))_
- We saw that an expression consisting solely of numbers, like 42 , is a literal. _(javascriptallonge.pdf (source-range-7239e085-00142))_
- So the literal 042 is 42 base 8, which is actually 34 base 10. _(javascriptallonge.pdf (source-range-7239e085-00142))_
- A computer's internal representation for numbers is important to understand. _(javascriptallonge.pdf (source-range-7239e085-00144))_
- Internally, both 042 and 34 have the same representation, as double-precision floating point 13 numbers. _(javascriptallonge.pdf (source-range-7239e085-00144))_
...
- In this book, we need not think about such details, but outside of this book, we must. _(javascriptallonge.pdf (source-range-7239e085-00155))_
- For example, '$43.21' will nearly always be presented as two numbers: 43 for dollars and 21 for cents, not 43.21 . _(javascriptallonge.pdf (source-range-7239e085-00155))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00149))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00154))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00158, source-range-7239e085-00160))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00161))_
...
**Atom:** _(javascriptallonge.pdf (source-range-7239e085-00166))_

> [Figure] (p.29)

#### As Little As Possible About Functions, But No Less

- Like numbers, strings, and arrays, they have a representation. _(javascriptallonge.pdf (source-range-7239e085-00168))_
- In JavaScript, functions are values, but they are also much more than simple numbers, strings, or even complex data structures like trees or maps. _(javascriptallonge.pdf (source-range-7239e085-00168))_
- Functions represent computations to be performed. _(javascriptallonge.pdf (source-range-7239e085-00168))_
- This is a function that is applied to no values and returns 0 . _(javascriptallonge.pdf (source-range-7239e085-00170))_
- This seems to break our rule that if an expression is also a value, JavaScript will give the same value back to us. _(javascriptallonge.pdf (source-range-7239e085-00172))_
- [Function] is a choice made by the people who wrote Node.js, the JavaScript environment that hosts the JavaScript REPL. _(javascriptallonge.pdf (source-range-7239e085-00172))_
- The simplest and easiest answer is that although the JavaScript interpreter does indeed return that value, displaying it on the screen is a slightly different matter. _(javascriptallonge.pdf (source-range-7239e085-00172))_
- But we must understand that whether we see [Function] or () => 0 , internally JavaScript has a full and proper function. _(javascriptallonge.pdf (source-range-7239e085-00174))_
- I'd prefer something else, but I must accept that what gets typed back to us on the screen is arbitrary, and all that really counts is that it is somewhat useful for a human to read. _(javascriptallonge.pdf (source-range-7239e085-00174))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00168))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00170, source-range-7239e085-00172))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00177))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00182, source-range-7239e085-00184))_
...
- For example, (() => 0)() is an expression. _(javascriptallonge.pdf (source-range-7239e085-00193))_
- Functions can return the value of evaluating another function. _(javascriptallonge.pdf (source-range-7239e085-00196))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00188))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00197))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00203))_
...
- There's another thing we can put to the right of an arrow, a block . _(javascriptallonge.pdf (source-range-7239e085-00210))_
- A block has zero or more statements , separated by semicolons. _(javascriptallonge.pdf (source-range-7239e085-00210))_
- It returns the result of evaluating a block that has no statements. _(javascriptallonge.pdf (source-range-7239e085-00213))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00211, source-range-7239e085-00213))_
...
- This works because JavaScript has a feature that can infer where the semi-colons should be most of the time. _(javascriptallonge.pdf (source-range-7239e085-00223))_
- In JavaScript, every undefined is identical to every other undefined . _(javascriptallonge.pdf (source-range-7239e085-00224))_
...
- You might think that undefined in JavaScript is equivalent to NULL in SQL. _(javascriptallonge.pdf (source-range-7239e085-00224))_
- In SQL, two things that are NULL are not equal to nor share the same identity, because two unknowns can't be equal. _(javascriptallonge.pdf (source-range-7239e085-00224))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00217))_
...
- void is an operator that takes any value and evaluates to undefined , always. _(javascriptallonge.pdf (source-range-7239e085-00231))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00229, source-range-7239e085-00231))_
...
- We haven't discussed these statements . _(javascriptallonge.pdf (source-range-7239e085-00238))_
...
- Basically, there's a step where JavaScript looks at your code and follows some rules to guess where you meant to put semicolons in should you leave them out. _(javascriptallonge.pdf (source-range-7239e085-00246))_
- Readers who follow internet flame-fests may be aware of something called automatic semicolon insertion. _(javascriptallonge.pdf (source-range-7239e085-00246))_
- Some programmers argue that since it's part of the language's definition, it's fair game to write code that exploits it, so they deliberately omit any semicolon that JavaScript will insert for them. _(javascriptallonge.pdf (source-range-7239e085-00246))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00239, source-range-7239e085-00241))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00246, source-range-7239e085-00250))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00248, source-range-7239e085-00250))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00250))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00254))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00263))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00265))_
...
- Up to now, we've looked at functions without arguments. _(javascriptallonge.pdf (source-range-7239e085-00270))_
- We haven't even said what an argument is , only that our functions don't have any. _(javascriptallonge.pdf (source-range-7239e085-00270))_
- So you know what they are, and I know that you know what they are, but please be patient with the explanation! _(javascriptallonge.pdf (source-range-7239e085-00271))_
- Most programmers are perfectly familiar with arguments (often called 'parameters'). _(javascriptallonge.pdf (source-range-7239e085-00271))_
- This function has one argument, room , and an empty body. _(javascriptallonge.pdf (source-range-7239e085-00274))_
- I'm sure you are perfectly comfortable with the idea that this function has two arguments, room , and board . _(javascriptallonge.pdf (source-range-7239e085-00276))_
- I read that aloud as 'When applied to a value representing the diameter, this function returns the diameter times 3.14159265.' _(javascriptallonge.pdf (source-range-7239e085-00278))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00272))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00279))_
...
- How arguments are used in a body's expression is probably perfectly obvious to you from the examples, especially if you've used any programming language (except for the dialect of BASIC-which I recall from my secondary school-that didn't allow parameters when you called a procedure). _(javascriptallonge.pdf (source-range-7239e085-00286))_
- One of the important possible statements is a return statement. _(javascriptallonge.pdf (source-range-7239e085-00288))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00293))_
...
- An environment is a (possibly empty) dictionary that maps variables to values by name. _(javascriptallonge.pdf (source-range-7239e085-00303))_
...
- Every time a function is invoked ('invoked' means 'applied to zero or more arguments'), a new environment is created. _(javascriptallonge.pdf (source-range-7239e085-00303))_
- You can apply a function to one or more functions. _(javascriptallonge.pdf (source-range-7239e085-00304))_
- 24 We said that you can't apply a function to an expression. _(javascriptallonge.pdf (source-range-7239e085-00304))_
- This has interesting applications, and they will be explored much more thoroughly in Functions That Are Applied to Functions. _(javascriptallonge.pdf (source-range-7239e085-00304))_
- When you apply the function to the arguments, an entry is placed in the dictionary for each argument. _(javascriptallonge.pdf (source-range-7239e085-00305))_
- Well for arguments, that is very simple. _(javascriptallonge.pdf (source-range-7239e085-00305))_
...
- meaning, that the environment is a dictionary, and that the value 2 is bound to the name x , and that there might be other stuff in that dictionary we aren't discussing right now. _(javascriptallonge.pdf (source-range-7239e085-00318))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00298))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00305))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00307))_
...
- As you recall, value types like strings and numbers are identical to each other if they have the same content. _(javascriptallonge.pdf (source-range-7239e085-00322))_
- We said that JavaScript binds names to values, but we didn't say what it means to bind a name to a value. _(javascriptallonge.pdf (source-range-7239e085-00322))_
- JavaScript does not place copies of reference values in any environment. _(javascriptallonge.pdf (source-range-7239e085-00324))_
- JavaScript places references to reference types in environments, and when the value needs to be used, JavaScript uses the reference to obtain the original. _(javascriptallonge.pdf (source-range-7239e085-00324))_
- Call by sharing is generally understood to be a specialization of call by value, and it explains why some values are known as value types and other values are known as reference types. _(javascriptallonge.pdf (source-range-7239e085-00325))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00326))_
...
- It makes sense that the result value is a function, because the expression for (x) => ... _(javascriptallonge.pdf (source-range-7239e085-00334))_
- So now we have a value representing that function. _(javascriptallonge.pdf (source-range-7239e085-00336))_
- There is no x in its environment, it must come from somewhere else. _(javascriptallonge.pdf (source-range-7239e085-00338))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00330, source-range-7239e085-00332))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00332, source-range-7239e085-00334))_
...
- It contains a free variable , x . _(javascriptallonge.pdf (source-range-7239e085-00343))_
...
- They always mean the same thing wherever you use them. _(javascriptallonge.pdf (source-range-7239e085-00347))_
- Pure functions are easiest to understand. _(javascriptallonge.pdf (source-range-7239e085-00347))_
...
- If you can't, give your reasoning for why it's impossible. _(javascriptallonge.pdf (source-range-7239e085-00351))_
- Using only what we've learned so far, attempt to compose a closure that contains a pure function. _(javascriptallonge.pdf (source-range-7239e085-00351))_
- We can't say what it will do with argument (2) without understanding the magic for evaluating the free variable x . _(javascriptallonge.pdf (source-range-7239e085-00352))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00347, source-range-7239e085-00352))_
...
- The first function is the result of currying a the second function. _(javascriptallonge.pdf (source-range-7239e085-00366))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00355))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00361))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00363, source-range-7239e085-00366))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00371, source-range-7239e085-00373))_
...
- This behaviour of pure functions and closures has many, many consequences that can be exploited to write software. _(javascriptallonge.pdf (source-range-7239e085-00378))_
...
- JavaScript always has the notion of at least one environment we do not control: A global environment in which many useful things are bound such as libraries full of standard functions. _(javascriptallonge.pdf (source-range-7239e085-00380))_
- As we'll see when we discuss mutable state, this helps to prevent programmers from accidentally changing the global state that is shared by all code in the program. _(javascriptallonge.pdf (source-range-7239e085-00383))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00380))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00381))_
...
- This feels very different from programming in most other languages, where the focus is on naming functions, methods, and procedures. _(javascriptallonge.pdf (source-range-7239e085-00385))_
- Naming things is a critical part of programming, but all we've seen so far is how to name arguments. _(javascriptallonge.pdf (source-range-7239e085-00385))_
- Up to now, all we've really seen are anonymous functions , functions that don't have a name. _(javascriptallonge.pdf (source-range-7239e085-00385))_
- In order to bind 3.14159265 to the name PI , we'll need a function with a parameter of PI applied to an argument of 3.14159265 . _(javascriptallonge.pdf (source-range-7239e085-00388))_
- This expression, when evaluated, returns a function that calculates circumferences. _(javascriptallonge.pdf (source-range-7239e085-00392))_
- But we can use it just like (diameter) => diameter * 3.14159265 . _(javascriptallonge.pdf (source-range-7239e085-00392))_
- This one has a few more moving parts, that's all. _(javascriptallonge.pdf (source-range-7239e085-00392))_
- All of our 'functions' are expressions. _(javascriptallonge.pdf (source-range-7239e085-00392))_
- We can bind anything we want in an expression by wrapping it in a function that is immediately invoked with the value we want to bind. _(javascriptallonge.pdf (source-range-7239e085-00396))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00390))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00393))_
...
- Explaining the pattern, Ben Alman coined the term [Immediately Invoked Function Expression][iife] for it, often abbreviated 'IIFE.' _(javascriptallonge.pdf (source-range-7239e085-00404))_
- 29 JavaScript programmers regularly use the idea of writing an expression that denotes a function and then immediately applying it to arguments. _(javascriptallonge.pdf (source-range-7239e085-00404))_
- Everything else is encapsulated in its body. _(javascriptallonge.pdf (source-range-7239e085-00406))_
- That's how it should be, naming PI is its concern, not ours. _(javascriptallonge.pdf (source-range-7239e085-00406))_
- Well, the wrinkle with this is that typically, invoking functions is considerably more expensive than evaluating expressions. _(javascriptallonge.pdf (source-range-7239e085-00410))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00398, source-range-7239e085-00400))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00400))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00404))_
...
- We use the const keyword in a const statement . _(javascriptallonge.pdf (source-range-7239e085-00423))_
- We can bind any expression. _(javascriptallonge.pdf (source-range-7239e085-00430))_
- A name that's bound to a function is a valid expression evaluating to a function. _(javascriptallonge.pdf (source-range-7239e085-00432))_
- Amazing how such an important idea-naming functions-can be explained en passant in just a few words. _(javascriptallonge.pdf (source-range-7239e085-00433))_
- 30 We're into the second chapter and we've finally named a function. _(javascriptallonge.pdf (source-range-7239e085-00436))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00415))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00417, source-range-7239e085-00419))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00420))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00424))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00428))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00434))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00438))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00440))_
...
- That much we can carefully work out from the way closures work. _(javascriptallonge.pdf (source-range-7239e085-00459))_
- Binding values to names with const works just like binding values to names with parameter invocations, it uses lexical scope. _(javascriptallonge.pdf (source-range-7239e085-00462))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00450))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00452, source-range-7239e085-00455))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00456))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00459))_
...
- We just saw that values bound with const use lexical scope, just like values bound with parameters. _(javascriptallonge.pdf (source-range-7239e085-00464))_
- Parameters are declared when we create functions, so it makes sense that parameters are bound to environments created when we invoke functions. _(javascriptallonge.pdf (source-range-7239e085-00464))_
- They are looked up in the environment where they are declared. _(javascriptallonge.pdf (source-range-7239e085-00464))_
...
- But const statements can appear inside blocks, and we saw that blocks can appear inside of other blocks, including function bodies. _(javascriptallonge.pdf (source-range-7239e085-00465))_
- But instead of binding two different variables to the same name in two different places, we'll bind two different values to the same name, but one environment will be completely enclosed by the other. _(javascriptallonge.pdf (source-range-7239e085-00466))_
- We can test this by creating another conflict. _(javascriptallonge.pdf (source-range-7239e085-00466))_
- And we can see that our diameter * PI expression uses the binding for PI in the closest parent environment. _(javascriptallonge.pdf (source-range-7239e085-00473))_
- This is a book, you've already scanned ahead, so you know that the answer is no , the inner binding does not overwrite the outer binding: _(javascriptallonge.pdf (source-range-7239e085-00475))_
...
- We'll need a gratuitous block. _(javascriptallonge.pdf (source-range-7239e085-00481))_
- Parameters are only bound when we invoke a function. _(javascriptallonge.pdf (source-range-7239e085-00481))_
- But const statements can appear inside blocks. _(javascriptallonge.pdf (source-range-7239e085-00481))_
- Parameters are only bound when we invoke a function. _(javascriptallonge.pdf (source-range-7239e085-00481))_
- Typically, we want to bind our names as close to where we need them as possible. _(javascriptallonge.pdf (source-range-7239e085-00489))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00467))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00469))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00471))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00473, source-range-7239e085-00475))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00485, source-range-7239e085-00487))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00485))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00487))_
...
- JavaScript does not permit us to rebind a name that has been bound with const . _(javascriptallonge.pdf (source-range-7239e085-00496))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00491))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00494))_
...
- This syntax binds an anonymous function to a name in an environment, but the function itself remains anonymous. _(javascriptallonge.pdf (source-range-7239e085-00501))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00499, source-range-7239e085-00501))_
...
- - We always use a block, we cannot write function (str) str + str . _(javascriptallonge.pdf (source-range-7239e085-00513))_
- This means that if we want our functions to return a value, we always need to use the return keyword _(javascriptallonge.pdf (source-range-7239e085-00513))_
- This is a named function expression . _(javascriptallonge.pdf (source-range-7239e085-00523))_
- That may seem confusing, but think of the binding names as properties of the environment, not of the function. _(javascriptallonge.pdf (source-range-7239e085-00523))_
- In this expression, double is the name in the environment, but repeat is the function's actual name. _(javascriptallonge.pdf (source-range-7239e085-00523))_
- While the name of the function is a property of the function, not of the environment. _(javascriptallonge.pdf (source-range-7239e085-00523))_
...
- Now, the function's actual name has no effect on the environment in which it is used. _(javascriptallonge.pdf (source-range-7239e085-00529))_
- Here's a function that determines whether a positive integer is even or not. _(javascriptallonge.pdf (source-range-7239e085-00531))_
- So 'actualName' isn't bound in the environment where we use the named function expression. _(javascriptallonge.pdf (source-range-7239e085-00531))_
...
- This is useful for making recursive functions as we see above, and it speaks to the principle of least privilege: If you don't need to name it anywhere else, you needn't. _(javascriptallonge.pdf (source-range-7239e085-00535))_
- even is bound within the function itself, but not outside it. _(javascriptallonge.pdf (source-range-7239e085-00535))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00504))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00506))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00514))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00516, source-range-7239e085-00518))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00519))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00521))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00524))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00526))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00531, source-range-7239e085-00535))_
...
- In that it binds a name in the environment to a named function. _(javascriptallonge.pdf (source-range-7239e085-00540))_
...
- It is not necessary to declare functions in this way in JavaScript, but understanding the syntax and its behaviour (especially the way it differs from const ) is essential for working with production code. _(javascriptallonge.pdf (source-range-7239e085-00546))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00537))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00537, source-range-7239e085-00541))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00541))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00549))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00558))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00564))_
...
- So one perspective is that combinators are useful when you want to emphasize what you're doing and how it fits together, and more explicit code is useful when you want to emphasize what you're working with. _(javascriptallonge.pdf (source-range-7239e085-00568))_
- Code that uses a lot of combinators tends to name the verbs and adverbs (like doubleOf , addOne , and compose ) while avoiding language keywords and the names of nouns (like number ). _(javascriptallonge.pdf (source-range-7239e085-00568))_

##### function decorators

- So instead of writing !someFunction(42) , we can write not(someFunction)(42) . _(javascriptallonge.pdf (source-range-7239e085-00572))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00574))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00576, source-range-7239e085-00578))_
...
- The strength of JavaScript is that you can do anything. _(javascriptallonge.pdf (source-range-7239e085-00580))_
- Although you needn't restrict yourself to a small number of simple patterns, it can be helpful to understand the patterns so that you can structure your code around some basic building blocks. _(javascriptallonge.pdf (source-range-7239e085-00580))_
- The weakness is that you will. _(javascriptallonge.pdf (source-range-7239e085-00580))_
- There are ifs, fors, returns, everything thrown higgledy piggledy together. _(javascriptallonge.pdf (source-range-7239e085-00580))_
...
- But once and maybe compose, so you can chain them together as you see fit: _(javascriptallonge.pdf (source-range-7239e085-00588))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00582))_
...
- mapWith takes any function as an argument and returns a partially applied map function. _(javascriptallonge.pdf (source-range-7239e085-00597))_
- The important thing to see is that partial application is orthogonal to composition, and that they both work together nicely: _(javascriptallonge.pdf (source-range-7239e085-00599))_
- Partial application also has a combinator, which we'll see in the partial recipe. _(javascriptallonge.pdf (source-range-7239e085-00603))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00592, source-range-7239e085-00595))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00595))_
...
- When a function is applied to arguments (or 'called'), JavaScript binds the values of arguments to the function's argument names in an environment created for the function's execution. _(javascriptallonge.pdf (source-range-7239e085-00605))_
- What we haven't discussed so far is that JavaScript also binds values to some 'magic' names in addition to any you put in the argument list. _(javascriptallonge.pdf (source-range-7239e085-00605))_
...
- arguments always contains all of the arguments passed to a function, regardless of how many are declared. _(javascriptallonge.pdf (source-range-7239e085-00612))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00608))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00610, source-range-7239e085-00612))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00615))_
...
- For example, when this expression's inner function is defined with function , arguments[0] refers to its only argument, "inner" : _(javascriptallonge.pdf (source-range-7239e085-00620))_
- But if we use a fat arrow, arguments will be defined in the outer environment, the one defined with function . _(javascriptallonge.pdf (source-range-7239e085-00622))_
...
- But for the purposes of discussing ideas, we can use the same name twice in two different contexts. _(javascriptallonge.pdf (source-range-7239e085-00628))_
- If we were writing a library of functions, we would have to disambiguate the two kinds of mapping functions with special names, namespaces, or modules. _(javascriptallonge.pdf (source-range-7239e085-00628))_
...
- Although this example is clearly unrealistic, there is a general design principle that deserves attention. _(javascriptallonge.pdf (source-range-7239e085-00631))_
- Sometimes, a function is meant to be used as a Big-F function. _(javascriptallonge.pdf (source-range-7239e085-00631))_
- It has a name, it is called by different pieces of code, it's a first-class entity in the code. _(javascriptallonge.pdf (source-range-7239e085-00631))_
- But sometimes, a function is a small-f function. _(javascriptallonge.pdf (source-range-7239e085-00632))_
- In our example above, row is a Big-F function, but (column) => column * arguments[0] is a small-f function, it exists just to give mapWith something to apply. _(javascriptallonge.pdf (source-range-7239e085-00632))_
- It's a simple representation of an expression to be computed. _(javascriptallonge.pdf (source-range-7239e085-00632))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00620))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00625, source-range-7239e085-00627))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00628, source-range-7239e085-00630))_
...
- As noted above, our partial recipe allows us to create functions that are partial applications of functions that are context aware. _(javascriptallonge.pdf (source-range-7239e085-00662))_
- callFirst and callLast were inspired by Michael Fogus' Lemonad. _(javascriptallonge.pdf (source-range-7239e085-00664))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00660, source-range-7239e085-00662))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00669))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00672, source-range-7239e085-00676))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00674, source-range-7239e085-00676))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00677))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00679))_
...
- tap is a traditional name borrowed from various Unix shell commands. _(javascriptallonge.pdf (source-range-7239e085-00687))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00689))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00696))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00704))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00706))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00712))_
...
- A variadic function is a function that is designed to accept a variable number of arguments. _(javascriptallonge.pdf (source-range-7239e085-00717))_
- 52 In JavaScript, you can make a variadic function by gathering parameters. _(javascriptallonge.pdf (source-range-7239e085-00717))_
- This can be useful when writing certain kinds of destructuring algorithms. _(javascriptallonge.pdf (source-range-7239e085-00719))_
...
- For example, we might want to have a function that builds some kind of team record. _(javascriptallonge.pdf (source-range-7239e085-00719))_
- 52 English is about as inconsistent as JavaScript: Functions with a fixed number of arguments can be unary, binary, ternary, and so forth. _(javascriptallonge.pdf (source-range-7239e085-00721))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00717))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00725, source-range-7239e085-00728))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00728))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00733))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00736))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00741))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00743))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00745))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00747, source-range-7239e085-00749))_
...
- In addition to numbers, we often need to represent a much more basic idea of truth or falsehood. _(javascriptallonge.pdf (source-range-7239e085-00753))_
- All values of true are === all other values of true. _(javascriptallonge.pdf (source-range-7239e085-00759))_
- We can see that is the case by looking at some operators we can perform on boolean values, ! _(javascriptallonge.pdf (source-range-7239e085-00759))_
- true and false are value types. _(javascriptallonge.pdf (source-range-7239e085-00759))_
- Now, note well: We have said what happens if you pass boolean values to ! _(javascriptallonge.pdf (source-range-7239e085-00763))_

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-00751))_

> [Figure] (p.94)

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00759))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00761))_
...
- Every other value in JavaScript is 'truthy' except the aforementioned false , null , undefined , NaN , 0 , and '' . _(javascriptallonge.pdf (source-range-7239e085-00766))_
- The reason why truthiness matters is that the various logical operators (as well as the if statement) actually operate on truthiness , not on boolean values. _(javascriptallonge.pdf (source-range-7239e085-00767))_
...
- It evaluates first , and if first is 'truthy', it evaluates second and that is its value. _(javascriptallonge.pdf (source-range-7239e085-00768))_
- This is a lot like the if statement, however it is an expression , not a statement, and that can be very valuable. _(javascriptallonge.pdf (source-range-7239e085-00770))_
- It also doesn't introduce braces, and that can be a help or a hindrance if we want to introduce a new scope or use statements. _(javascriptallonge.pdf (source-range-7239e085-00770))_
- The fact that either the second or the third (but not both) expressions are evaluated can have important repercussions. _(javascriptallonge.pdf (source-range-7239e085-00773))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00771))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00777, source-range-7239e085-00779))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00788))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00801))_
...
- Arrays are JavaScript's 'native' representation of lists. _(javascriptallonge.pdf (source-range-7239e085-00818))_
...
- While we have mentioned arrays briefly, we haven't had a close look at them. _(javascriptallonge.pdf (source-range-7239e085-00818))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00820))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00824))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00826))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00829))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00834))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00841))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00845))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00850))_
...
- car and cdr 57 are archaic terms that go back to an implementation of Lisp running on the IBM 704 computer. _(javascriptallonge.pdf (source-range-7239e085-00855))_
- notation does not provide a universal patten-matching capability. _(javascriptallonge.pdf (source-range-7239e085-00856))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00853))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00863, source-range-7239e085-00865))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00865, source-range-7239e085-00869))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00874))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00876))_
...
- Some are empty, some have three items, some forty-two, some contain numbers, some contain strings, some a mixture of elements, there are all kinds of lists. _(javascriptallonge.pdf (source-range-7239e085-00886))_
- Some data structures, like lists, can obviously be seen as a collection of items. _(javascriptallonge.pdf (source-range-7239e085-00886))_
- But we can also define a list by describing a rule for building lists. _(javascriptallonge.pdf (source-range-7239e085-00887))_
- - Consists of an element concatenated with a list . _(javascriptallonge.pdf (source-range-7239e085-00889))_
- We can express that using a spread. _(javascriptallonge.pdf (source-range-7239e085-00890))_
- The first rule is simple: [] is a list. _(javascriptallonge.pdf (source-range-7239e085-00890))_
- Given an element e and a list list , [e, ...list] is a list. _(javascriptallonge.pdf (source-range-7239e085-00890))_
...
- We know that we can get the length of an array using its .length . _(javascriptallonge.pdf (source-range-7239e085-00897))_
- 61 Well, actually, this does not work for arrays that contain undefined as a value, but we are not going to see that in our examples. _(javascriptallonge.pdf (source-range-7239e085-00898))_
- We need something for when the array isn't empty. _(javascriptallonge.pdf (source-range-7239e085-00901))_
- If an array is not empty, and we break it into two pieces, first and rest , the length of our array is going to be length(first) + length(rest) . _(javascriptallonge.pdf (source-range-7239e085-00901))_
- If only there was a function we could call… Like length ! _(javascriptallonge.pdf (source-range-7239e085-00901))_
- Well, the length of first is 1 , there's just one element at the front. _(javascriptallonge.pdf (source-range-7239e085-00901))_
- If only there was a function we could call… Like length ! _(javascriptallonge.pdf (source-range-7239e085-00901))_
- Our length function is recursive , it calls itself. _(javascriptallonge.pdf (source-range-7239e085-00904))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00890))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00899))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00899, source-range-7239e085-00904))_
...
- This simpler form of 'divide and conquer' is called linear recursion . _(javascriptallonge.pdf (source-range-7239e085-00916))_
- We need a test for the terminal case. _(javascriptallonge.pdf (source-range-7239e085-00917))_
- The next terminal case is that if an element isn't an array, we don't flatten it, and can put it together with the rest of our solution directly. _(javascriptallonge.pdf (source-range-7239e085-00919))_
- The usual 'terminal case' will be that flattening an empty array will produce an empty array. _(javascriptallonge.pdf (source-range-7239e085-00919))_
- Unfolds can be thought of a 'path' through a data structure, and flattening a tree is equivalent to a depth-first traverse. _(javascriptallonge.pdf (source-range-7239e085-00921))_
- 62 flatten is a very simple unfold, a function that takes a seed value and turns it into an array. _(javascriptallonge.pdf (source-range-7239e085-00921))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00917))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00920))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00926))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00928))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00931))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00936, source-range-7239e085-00938))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00941))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00947))_
...
- Its specialized cases of mapping and folding are especially useful and can be used to build other functions. _(javascriptallonge.pdf (source-range-7239e085-00952))_
- Linear recursion is a basic building block of algorithms. _(javascriptallonge.pdf (source-range-7239e085-00952))_
- And finally, while folding is a special case of linear recursion, mapping is a special case of folding. _(javascriptallonge.pdf (source-range-7239e085-00952))_
- Its basic form parallels the way linear data structures like lists are constructed: This helps make it understandable. _(javascriptallonge.pdf (source-range-7239e085-00952))_

#### Tail Calls (and Default Arguments)

- One of the reasons they are not production-ready is that they consume memory proportional to the size of the array being folded. _(javascriptallonge.pdf (source-range-7239e085-00954))_
- The mapWith and foldWith functions we wrote in Self-Similarity are useful for illustrating the basic principles behind using recursion to work with self-similar data structures, but they are not 'production-ready' implementations. _(javascriptallonge.pdf (source-range-7239e085-00954))_
- First, mapWith((x) => x * x, [1, 2, 3, 4, 5]) is invoked. _(javascriptallonge.pdf (source-range-7239e085-00957))_
...
- first is not undefined , so it evaluates [fn(first), …mapWith(fn, rest)]. _(javascriptallonge.pdf (source-range-7239e085-00957))_
- To do that, it has to evaluate fn(first) and mapWith(fn, rest) , then evaluate [fn(first), ...mapWith(fn, rest)] . _(javascriptallonge.pdf (source-range-7239e085-00957))_
- So we know that JavaScript is going to hang on to 1 . _(javascriptallonge.pdf (source-range-7239e085-00960))_
- JavaScript cannot throw first away. _(javascriptallonge.pdf (source-range-7239e085-00960))_
- Next, JavaScript invokes mapWith(fn, rest) , which is semantically equivalent to mapWith((x) => x * x, [2, 3, 4, 5]) . _(javascriptallonge.pdf (source-range-7239e085-00961))_
- And the same thing happens: JavaScript has to hang on to 2 (or 4 , or both, depending on the implementation), plus some housekeeping information so it remembers what to do with that value, while it calls the equivalent of mapWith((x) => x * x, [3, 4, 5]) . _(javascriptallonge.pdf (source-range-7239e085-00961))_
- It can start assembling the resulting array and start discarding the information it is saving. _(javascriptallonge.pdf (source-range-7239e085-00962))_
...
- That information is saved on a call stack , and it is quite expensive. _(javascriptallonge.pdf (source-range-7239e085-00963))_
...
- Making algorithms faster is a very highly studied field of computer science. _(javascriptallonge.pdf (source-range-7239e085-00966))_
- In fact, there are several better ways. _(javascriptallonge.pdf (source-range-7239e085-00966))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-00955))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00958, source-range-7239e085-00960))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00958))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00964))_
...
- And in fact, it does exactly that: It throws the stack frame away, and does not consume extra memory when making a maybe -wrapped call. _(javascriptallonge.pdf (source-range-7239e085-00971))_
- That is excellent, but one wrapping is not a big deal. _(javascriptallonge.pdf (source-range-7239e085-00972))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00968, source-range-7239e085-00970))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00972, source-range-7239e085-00974))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00978, source-range-7239e085-00980))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00989))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00991, source-range-7239e085-00994))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-00996))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01001))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01005))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01007))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01011))_
...
- But when we try it on very large arrays, we discover that it is still very slow. _(javascriptallonge.pdf (source-range-7239e085-01019))_
- The right tool to discover why it's still slow is a memory profiler, but a simple inspection of the program will reveal the following: _(javascriptallonge.pdf (source-range-7239e085-01019))_
- To do that, we take the array in prepend and push fn(first) onto the end, creating a new array that will be passed to the next invocation of mapWith . _(javascriptallonge.pdf (source-range-7239e085-01020))_
- In GC environments, it is marked as no longer being used, and eventually the garbage collector recycles the memory it is using. _(javascriptallonge.pdf (source-range-7239e085-01022))_
- The array we had in prepend is no longer used. _(javascriptallonge.pdf (source-range-7239e085-01022))_
...
- Lather, rinse, repeat: Ever time we call mapWith , we're creating a new array, copying all the elements from prepend into the new array, and then we no longer use prepend . _(javascriptallonge.pdf (source-range-7239e085-01022))_
- Although the maximum amount of memory does not grow, the thrashing as we create short-lived arrays is very bad, and we do a lot of work copying elements from one array to another. _(javascriptallonge.pdf (source-range-7239e085-01023))_
- We may not be creating 3,000 stack frames, but we are creating three thousand new arrays and copying elements into each and every one of them. _(javascriptallonge.pdf (source-range-7239e085-01023))_
...
- Key Point : Our [first, ...rest] approach to recursion is slow because that it creates a lot of temporary arrays, and it spends an enormous amount of time copying elements into arrays that end up being discarded. _(javascriptallonge.pdf (source-range-7239e085-01024))_
- But this is not how JavaScript's built-in arrays work. _(javascriptallonge.pdf (source-range-7239e085-01026))_
...
- Although the 704 used core memory, it still used vacuum tubes for its logic. _(javascriptallonge.pdf (source-range-7239e085-01034))_
- Thus, the design of programming languages and algorithms was driven by what could be accomplished with limited memory and performance. _(javascriptallonge.pdf (source-range-7239e085-01034))_
...
- Getting one reference to a structure that already exists is faster than copying a bunch of elements. _(javascriptallonge.pdf (source-range-7239e085-01047))_
- There's no making copies of arrays, the time to cdr a list with five elements is the same as the time to cdr a list with 5,000 elements, and no temporary arrays are needed. _(javascriptallonge.pdf (source-range-7239e085-01047))_
- In JavaScript, it's still much, much, much faster to get all the elements except the head from a linked list than from an array. _(javascriptallonge.pdf (source-range-7239e085-01047))_
...
- So now we understand that in Lisp, a lot of things use linked lists, and they do that in part because it was what the hardware made possible. _(javascriptallonge.pdf (source-range-7239e085-01048))_
- That being said, it is easy to understand and helps us grasp how literals and destructuring works, and how recursive algorithms ought to mirror the self-similarity of the data structures they manipulate. _(javascriptallonge.pdf (source-range-7239e085-01050))_
- And so it is today that languages like JavaScript have arrays that are slow to split into the equivalent of a car / cdr pair, but instructional examples of recursive programs still have echoes of their Lisp origins. _(javascriptallonge.pdf (source-range-7239e085-01050))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01035))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01037))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01040))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01045, source-range-7239e085-01047))_
...
- But not for iterating over a list: Pointer chasing through memory is quite a bit slower than incrementing an index. _(javascriptallonge.pdf (source-range-7239e085-01055))_
- Well, linked lists are fast for a few things, like taking the front element off a list, and taking the remainder of a list. _(javascriptallonge.pdf (source-range-7239e085-01055))_
- If we make any change other than cons-ing a new element to the front, we are changing both the new list and the old list. _(javascriptallonge.pdf (source-range-7239e085-01056))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01054))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01055))_
...
- Although we showed how to use tail calls to map and fold over arrays with [first, ...rest] , in reality this is not how it ought to be done. _(javascriptallonge.pdf (source-range-7239e085-01060))_
- But it is an extremely simple illustration of how recursion works when you have a self-similar means of constructing a data structure. _(javascriptallonge.pdf (source-range-7239e085-01060))_
...
- Remembering that the name is the first item is error-prone, and being expected to look at user[0][1] and know that we are talking about a surname is unreasonable. _(javascriptallonge.pdf (source-range-7239e085-01065))_
- So back when lists were the only things available, programmers would introduce constants to make things easier on themselves: _(javascriptallonge.pdf (source-range-7239e085-01065))_
- Over time, this need to build heterogeneous data structures with access to members by name evolved into the Dictionary 69 data type, a mapping from a unique set of objects to another set of objects. _(javascriptallonge.pdf (source-range-7239e085-01067))_
- Now they could write user[NAME][LAST] or user[OCCUPATION][TITLE] instead of user[0][1] or user[1][0] . _(javascriptallonge.pdf (source-range-7239e085-01067))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01062))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01073))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01075))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01085))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01087))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01089))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01095))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01097))_
...
- We have unwittingly reversed the list. _(javascriptallonge.pdf (source-range-7239e085-01114))_
- This makes sense, if lists are constructed from back to front, and we make a linked list out of items as we iterate through it, we're going to get a backwards copy of the list. _(javascriptallonge.pdf (source-range-7239e085-01114))_
...
- For a list of length n , wecreated n superfluous nodes and copied n superfluous values. _(javascriptallonge.pdf (source-range-7239e085-01117))_
- Mind you, this is still much, much faster than making partial copies of arrays. _(javascriptallonge.pdf (source-range-7239e085-01117))_
- Whereas our naïve array algorithm created 2 n superfluous arrays and copied n 2 superfluous values. _(javascriptallonge.pdf (source-range-7239e085-01117))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01104))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01106, source-range-7239e085-01109))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01112))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01114, source-range-7239e085-01116))_
...
- In JavaScript, almost every type of value can mutate . _(javascriptallonge.pdf (source-range-7239e085-01121))_
- Specifically, arrays and objects can mutate. _(javascriptallonge.pdf (source-range-7239e085-01121))_
- Recall that you can access a value from within an array or an object using [] . _(javascriptallonge.pdf (source-range-7239e085-01121))_
- Wehave established that JavaScript's semantics allow for two different bindings to refer to the same value. _(javascriptallonge.pdf (source-range-7239e085-01127))_
...
- Both halloween and allHallowsEve are bound to the same array value within the local environment. _(javascriptallonge.pdf (source-range-7239e085-01129))_
- In each of these examples, we have created two aliases for the same value. _(javascriptallonge.pdf (source-range-7239e085-01131))_
...
- There are two nested environments, and each one binds a name to the exact same array value. _(javascriptallonge.pdf (source-range-7239e085-01131))_
- Before we could reassign things, the most important point about this is that the identities were the same, because they were the same value. _(javascriptallonge.pdf (source-range-7239e085-01131))_
...
- The outer value of allHallowsEve was not changed because all we did was rebind the name halloween within the inner environment. _(javascriptallonge.pdf (source-range-7239e085-01134))_
- We haven't rebound the inner name to a different variable, we've mutated the value that both bindings share. _(javascriptallonge.pdf (source-range-7239e085-01136))_
- Mutating existing objects has special implications when two bindings are aliases of the same value. _(javascriptallonge.pdf (source-range-7239e085-01138))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01123))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01125))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01129, source-range-7239e085-01131))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01132, source-range-7239e085-01134))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01132))_
...
- We just use the data, and the less we mutate it, the fewer the times we have to think about whether making changes will be 'safe.' _(javascriptallonge.pdf (source-range-7239e085-01151))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01143))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01144))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01147))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01153))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01158))_
...
- Like some imperative programming languages, JavaScript allows you to re-assign the value bound to parameters. _(javascriptallonge.pdf (source-range-7239e085-01162))_
- JavaScript does not permit us to rebind a name that has been bound with const . _(javascriptallonge.pdf (source-range-7239e085-01167))_
- We can shadow it by using const to declare a new binding with a new function or block scope, but we cannot rebind a name that was bound with const in an existing scope. _(javascriptallonge.pdf (source-range-7239e085-01167))_
- What we want is a statement that works like const , but permits us to rebind variables. _(javascriptallonge.pdf (source-range-7239e085-01168))_
- The key is to understand that we are rebinding a different value to the same name in the same environment. _(javascriptallonge.pdf (source-range-7239e085-01170))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01163))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01165))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01168))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01171, source-range-7239e085-01173))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01176))_
...
- The suggestion is that shadowing a variable is confusing code. _(javascriptallonge.pdf (source-range-7239e085-01180))_
- Shadowing a let with a const does not change our ability to rebind the variable in its original scope. _(javascriptallonge.pdf (source-range-7239e085-01183))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01181))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01187))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01191, source-range-7239e085-01194))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01194, source-range-7239e085-01196))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01196))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01198))_
...
- 72 There is a well known story about Karl Friedrich Gauss when he was in elementary school. _(javascriptallonge.pdf (source-range-7239e085-01206))_
- But Gauss rearranged the numbers to add them like this: (1 + 100) + (2 + 99) + (3 + 98) + . _(javascriptallonge.pdf (source-range-7239e085-01206))_
- There are 50 pairs of numbers, so the answer is 50*101 = 5050. _(javascriptallonge.pdf (source-range-7239e085-01206))_
- If you notice every pair of numbers adds up to 101. _(javascriptallonge.pdf (source-range-7239e085-01206))_
- His teacher got mad at the class and told them to add the numbers 1 to 100 and give him the answer by the end of the class. _(javascriptallonge.pdf (source-range-7239e085-01206))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01203, source-range-7239e085-01206))_
...
- The answer is that pesky var i . _(javascriptallonge.pdf (source-range-7239e085-01213))_
- But at the time we call one of the functions, i has the value 3 , which is why the loop terminated. _(javascriptallonge.pdf (source-range-7239e085-01215))_
...
- Now, at the time we created each function, i had a sensible value, like 0 , 1 , or 2 . _(javascriptallonge.pdf (source-range-7239e085-01215))_
- So when the function is called, JavaScript looks i up in its enclosing environment (its closure, obviously), and gets the value 3 . _(javascriptallonge.pdf (source-range-7239e085-01215))_
...
- This works, but let is so much simpler and cleaner that it was added to the language in the ECMAScript 2015 specification. _(javascriptallonge.pdf (source-range-7239e085-01220))_
- That does not mean that you should follow the exact same practice in your own code: The purpose of this book is to illustrate certain principles of programming. _(javascriptallonge.pdf (source-range-7239e085-01221))_
- The two goals are often, but not always, aligned. _(javascriptallonge.pdf (source-range-7239e085-01221))_
- The purpose of your own code is to get things done. _(javascriptallonge.pdf (source-range-7239e085-01221))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01211, source-range-7239e085-01213))_
...
- We've seen how to build lists with arrays and with linked lists. _(javascriptallonge.pdf (source-range-7239e085-01225))_
...
- And therefore, modifications to the parent do not affect the child, and modifications to the child do not affect the parent. _(javascriptallonge.pdf (source-range-7239e085-01228))_
- If we know that a list doesn't share any elements with another list, we can safely modify it. _(javascriptallonge.pdf (source-range-7239e085-01232))_
- We'll end up reinventing reference counting and garbage collection. _(javascriptallonge.pdf (source-range-7239e085-01232))_

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01223))_

> [Figure] (p.158)

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01227, source-range-7239e085-01229))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01227))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01230))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01234))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01239, source-range-7239e085-01241))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01245))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01247))_
...
- This algorithm is called 'The Tortoise and the Hare,' and was discovered by Robert Floyd in the 1960s. _(javascriptallonge.pdf (source-range-7239e085-01265))_
- No matter how large it is, you will eventually have the fast reference equal to the slow reference, and thus you'll detect the loop. _(javascriptallonge.pdf (source-range-7239e085-01265))_
- It seems to be faster under certain circumstances, depending on the size of the loop and the relative costs of certain operations. _(javascriptallonge.pdf (source-range-7239e085-01268))_
- What's interesting about these two algorithms is that they both tangle two separate concerns: How to traverse a data structure, and what to do with the elements that you encounter. _(javascriptallonge.pdf (source-range-7239e085-01269))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01261))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01266))_
...
- The nice thing about this is that the definition for arraySum mostly concerns itself with summing, and not with traversing over a collection of data. _(javascriptallonge.pdf (source-range-7239e085-01276))_
- But it still relies on foldArrayWith , so it can only sum arrays. _(javascriptallonge.pdf (source-range-7239e085-01276))_
- Perhaps we could extract both of those things. _(javascriptallonge.pdf (source-range-7239e085-01278))_
- Well, we call arraySum with an array, and it has baked into it a method for traversing the array. _(javascriptallonge.pdf (source-range-7239e085-01278))_
- The sumFoldable function doesn't care what kind of data structure we have, as long as it's foldable. _(javascriptallonge.pdf (source-range-7239e085-01280))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01272))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01274))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01278))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01281))_
...
- Notice that buried inside our loop, we have bound the names done and value . _(javascriptallonge.pdf (source-range-7239e085-01291))_
- Now this is something else. _(javascriptallonge.pdf (source-range-7239e085-01294))_
- The arrayIterator function takes an array and returns a function we can call repeatedly to obtain the elements of the array. _(javascriptallonge.pdf (source-range-7239e085-01294))_
- We can write a different iterator for a different data structure. _(javascriptallonge.pdf (source-range-7239e085-01295))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01286))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01289))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01299))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01304))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01316, source-range-7239e085-01319))_
...
- One is that while functions like take(...) appear to create an entirely new iterator, in reality they return a decorated reference to the original iterator. _(javascriptallonge.pdf (source-range-7239e085-01323))_
- There are some important implications of stateful functions. _(javascriptallonge.pdf (source-range-7239e085-01323))_
...
- In our code so far, we have used arrays and objects to represent the structure of data, and we have extensively used the ternary operator to write algorithms that terminate when we reach a base case. _(javascriptallonge.pdf (source-range-7239e085-01328))_
- For example, this length function uses a functions to bind values to names, POJOs to structure nodes, and the ternary function to detect the base case, the empty list. _(javascriptallonge.pdf (source-range-7239e085-01328))_
- They searched for a radically simpler set of tools that could accomplish all of the same things. _(javascriptallonge.pdf (source-range-7239e085-01330))_
- They established that arbitrary computations could be represented a small set of axiomatic components. _(javascriptallonge.pdf (source-range-7239e085-01331))_
- We can model lists just using functions. _(javascriptallonge.pdf (source-range-7239e085-01331))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01345))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01350))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01354))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01356))_
...
- As an aside, the Vireo is a little like JavaScript's .apply function. _(javascriptallonge.pdf (source-range-7239e085-01374))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01365))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01369))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01371))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01377))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01379))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01390))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01392))_
...
- There are lots of similar texts explaining how to construct complex semantics out of functions. _(javascriptallonge.pdf (source-range-7239e085-01401))_
- You can establish that K and K(I) can represent true and false , model magnitudes with Church Numerals 79 or Surreal Numbers 80 , and build your way up to printing FizzBuzz. _(javascriptallonge.pdf (source-range-7239e085-01401))_
- They are 'axioms' of combinatory logic, and can be used to compute anything that JavaScript can compute. _(javascriptallonge.pdf (source-range-7239e085-01403))_
- Functions are a fundamental building block of computation. _(javascriptallonge.pdf (source-range-7239e085-01403))_
- However, that is not the interesting thing to note here. _(javascriptallonge.pdf (source-range-7239e085-01404))_
- Practically speaking, languages like JavaScript already provide arrays with mapping and folding methods, choice operations, and other rich constructs. _(javascriptallonge.pdf (source-range-7239e085-01404))_
- Knowing how to make a linked list out of functions is not really necessary for the working programmer. _(javascriptallonge.pdf (source-range-7239e085-01404))_
- Knowing how to make a list out of just functions is a little like knowing that photons are the Gauge Bosons 81 of the electromagnetic force. _(javascriptallonge.pdf (source-range-7239e085-01405))_
...
- We're passing list what we want done with an empty list, and what we want done with a list that has at least one element. _(javascriptallonge.pdf (source-range-7239e085-01416))_
- We then ask list to do it, and provide a way for list to call the code we pass in. _(javascriptallonge.pdf (source-range-7239e085-01416))_
- This is fundamentally not the same thing as this code for the length of a linked list: _(javascriptallonge.pdf (source-range-7239e085-01417))_
- It presumes you can compare these things with the === operator. _(javascriptallonge.pdf (source-range-7239e085-01419))_
- We can fix this with an isEmpty function, but now we're pushing even more knowledge about the structure of lists into the code that uses them. _(javascriptallonge.pdf (source-range-7239e085-01419))_
- It presumes there is one canonical empty list value. _(javascriptallonge.pdf (source-range-7239e085-01419))_
- Having a list know itself whether it is empty hides implementation information from the code that uses lists. _(javascriptallonge.pdf (source-range-7239e085-01420))_
- It is a tenet of Object-Oriented Programming, but it is not exclusive to OOP: We can and should design data structures to hide implementation information from the code that use them, whether we are working with functions, objects, or both. _(javascriptallonge.pdf (source-range-7239e085-01420))_
- This is a fundamental principle of good design. _(javascriptallonge.pdf (source-range-7239e085-01420))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01411))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01414, source-range-7239e085-01417))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01417))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01430))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01432))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01432, source-range-7239e085-01437))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01440, source-range-7239e085-01442))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01448))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01450))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01452))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01454))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01456))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01458))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01473))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01475))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01479))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01482))_
...
- This has little practical utility in JavaScript, but in combinatory logic it's essential: With fixed-point combinators it's possible to compute everything computable without binding names. _(javascriptallonge.pdf (source-range-7239e085-01489))_
- It enables you to make recursive functions without needing to bind a function to a name in an environment. _(javascriptallonge.pdf (source-range-7239e085-01489))_
- Well, besides all of the practical applications that combinators provide, there is this little thing called The joy of working things out. _(javascriptallonge.pdf (source-range-7239e085-01490))_
- There are many explanations of the Y Combinator's mechanism on the internet, but resist the temptation to read any of them: Work it out for yourself. _(javascriptallonge.pdf (source-range-7239e085-01491))_
- One tip is to use JavaScript to name things. _(javascriptallonge.pdf (source-range-7239e085-01492))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01492))_
...
- Special characters can be included in a string literal by means of an escape sequence . _(javascriptallonge.pdf (source-range-7239e085-01500))_
- There are operators that can be used on strings. _(javascriptallonge.pdf (source-range-7239e085-01501))_
- Writing is a big part of what makes us human, and strings are how JavaScript and most other languages represent writing. _(javascriptallonge.pdf (source-range-7239e085-01503))_
- String manipulation is extremely common in programming. _(javascriptallonge.pdf (source-range-7239e085-01503))_

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01498))_

> [Figure] (p.202)

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01501))_
...
- However, there is a big semantic difference between a quasi-literal and an expression. _(javascriptallonge.pdf (source-range-7239e085-01513))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01508, source-range-7239e085-01510))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01510, source-range-7239e085-01513))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01520))_
...
**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01523))_

> [Figure] (p.205)

#### Iteration and Iterables

- Many objects in JavaScript can model collections of things. _(javascriptallonge.pdf (source-range-7239e085-01528))_
- But sometimes you want to open it up and do things with its contents. _(javascriptallonge.pdf (source-range-7239e085-01528))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01532))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01537))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01539))_
...
- Iteration for functions and objects has been around for many, many decades. _(javascriptallonge.pdf (source-range-7239e085-01546))_
- In programs involving large collections of objects, it can be handy to implement iterators as objects, rather than functions. _(javascriptallonge.pdf (source-range-7239e085-01547))_
...
- The mechanics of iterating can then be factored using the same tools that are used to factor the mechanics of all other objects in the system. _(javascriptallonge.pdf (source-range-7239e085-01547))_
- Fortunately, an iterator object is almost as simple as an iterator function. _(javascriptallonge.pdf (source-range-7239e085-01548))_
- Instead of having a function that you call to get the next element, you have an object with a .next() method. _(javascriptallonge.pdf (source-range-7239e085-01548))_

## Like this:

- When working with objects, we do things the object way. _(javascriptallonge.pdf (source-range-7239e085-01552))_
- Now our .iterator() method is returning an iterator object. _(javascriptallonge.pdf (source-range-7239e085-01552))_
- But having started by building functional iterators, we understand what is happening underneath the object's scaffolding. _(javascriptallonge.pdf (source-range-7239e085-01552))_
...
- To ensure that the method would not conflict with any existing code, JavaScript provides a symbol . _(javascriptallonge.pdf (source-range-7239e085-01556))_
...
- Our stack does, so instead of binding the existing iterator method to the name iterator , we bind it to the Symbol.iterator . _(javascriptallonge.pdf (source-range-7239e085-01559))_
- The for...of loop works directly with any object that is iterable , meaning it works with any object that has a Symbol.iterator method that returns an object iterator. _(javascriptallonge.pdf (source-range-7239e085-01562))_
- ) can spread the elements of an array in an array literal or as parameters in a function invocation. _(javascriptallonge.pdf (source-range-7239e085-01564))_
- Nowis the time to note that we can spread any iterable. _(javascriptallonge.pdf (source-range-7239e085-01565))_
...
- That might be very wasteful for extremely large collections. _(javascriptallonge.pdf (source-range-7239e085-01570))_
- For example, if we spread a large collection just to find an element in the collection, it might have been wiser to iterate over the element using its iterator directly. _(javascriptallonge.pdf (source-range-7239e085-01570))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01559))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01565))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01567))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01573))_
...
- Therefore, RandomNumbers is not an ordered collection. _(javascriptallonge.pdf (source-range-7239e085-01584))_
- Every time we get an iterator from an ordered collection, we start iterating from the beginning. _(javascriptallonge.pdf (source-range-7239e085-01585))_
- To reiterate (hah), an ordered collection represents a (possibly infinite) collection of elements that are in some order. _(javascriptallonge.pdf (source-range-7239e085-01585))_
- Right now, we're just looking at ordered collections. _(javascriptallonge.pdf (source-range-7239e085-01585))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01579))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01582, source-range-7239e085-01584))_
...
- They do so by taking care to iterate over a result freshly every time we get an iterator for them. _(javascriptallonge.pdf (source-range-7239e085-01591))_
- Many operations on ordered collections return another ordered collection. _(javascriptallonge.pdf (source-range-7239e085-01591))_
- Numbers is an ordered collection. _(javascriptallonge.pdf (source-range-7239e085-01593))_
...
- first returns the first element of an iterable (if it has one), and rest returns an iterable that iterates over all but the first element of an iterable. _(javascriptallonge.pdf (source-range-7239e085-01607))_
- For completeness, here are two more handy iterable functions. _(javascriptallonge.pdf (source-range-7239e085-01607))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01588, source-range-7239e085-01591))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01591))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01593, source-range-7239e085-01595))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01597))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01601))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01604))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01612))_
...
- Iterators are a JavaScript feature that allow us to separate the concerns of how to iterate over a collection from what we want to do with the elements of a collection. _(javascriptallonge.pdf (source-range-7239e085-01620))_
- Iterable ordered collections can be iterated over or gathered into another collection. _(javascriptallonge.pdf (source-range-7239e085-01620))_
...
- Iterables look cool, but then again, everything looks amazing when you're given cherry-picked examples. _(javascriptallonge.pdf (source-range-7239e085-01625))_
- Whether it's a simple functional iterator, or an iterable object with a .next() method, an iterator is something we call repeatedly until it tells us that it's done. _(javascriptallonge.pdf (source-range-7239e085-01626))_
- This seems blindingly obvious and simple. _(javascriptallonge.pdf (source-range-7239e085-01627))_
- There is no concept of pushing numbers out from the iterator, just waiting until a number is pulled out of the iterator by whatever code consumes numbers. _(javascriptallonge.pdf (source-range-7239e085-01630))_
- Of course, when we have some code that makes a bunch of something, we don't usually write it like that. _(javascriptallonge.pdf (source-range-7239e085-01631))_
- We would generate numbers. _(javascriptallonge.pdf (source-range-7239e085-01633))_
- And magically, the numbers would pour forth. _(javascriptallonge.pdf (source-range-7239e085-01633))_
- Well, there are some collections that are much easier to generate than to iterate over. _(javascriptallonge.pdf (source-range-7239e085-01635))_

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01623))_

> [Figure] (p.224)

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01626))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01627))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01631))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01640, source-range-7239e085-01644))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01650, source-range-7239e085-01653))_
...
- Again, this is not particularly horrendous, but like the recursive example, we're explicitly greenspunning the natural linear state. _(javascriptallonge.pdf (source-range-7239e085-01658))_
...
- In a generator, we write 'do this, then this, then this.' In an iterator, we have to wrap that up and explicitly keep track of what step we're on. _(javascriptallonge.pdf (source-range-7239e085-01658))_
- So we see the same thing: The generation version has state, but it's implicit in JavaScript's linear control flow. _(javascriptallonge.pdf (source-range-7239e085-01659))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01664, source-range-7239e085-01667))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01664))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01669))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01673))_
...
- There are no more lines of code, so it ends. _(javascriptallonge.pdf (source-range-7239e085-01698))_
...
- Coroutines are computer program components that generalize subroutines for nonpreemptive multitasking, by allowing multiple entry points for suspending and resuming execution at certain locations. _(javascriptallonge.pdf (source-range-7239e085-01701))_
...
- Coroutines are well-suited for implementing more familiar program components such as cooperative tasks, exceptions, event loop, iterators, infinite lists and pipes. _(javascriptallonge.pdf (source-range-7239e085-01701))_
- The iterator is the producer, and the code that iterates over it is the consumer. _(javascriptallonge.pdf (source-range-7239e085-01702))_
- With an iterator, we can call them the producer and the consumer . _(javascriptallonge.pdf (source-range-7239e085-01702))_
- Of course, generators need not be implemented exactly as coroutines. _(javascriptallonge.pdf (source-range-7239e085-01704))_
...
- For example, a 'transpiler' might implement oneTwoThree as a state machine, a little like this (there is more to generators, but we'll see that later): _(javascriptallonge.pdf (source-range-7239e085-01704))_
- But no matter how JavaScript implements it, our mental model is that a generator function returns an iterator, and that when we call .next() , it runs until it returns, ends, or yields. _(javascriptallonge.pdf (source-range-7239e085-01706))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01677))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01704))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01708, source-range-7239e085-01711))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01709, source-range-7239e085-01711))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01712, source-range-7239e085-01714))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01717, source-range-7239e085-01720))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01723))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01726))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01729, source-range-7239e085-01732))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01729))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01732))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01736))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01738))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01748))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01750))_
...
- Using a generator instead of writing an iterator object that has a .next() method allows us to write code that can be much simpler for cases like recursive iterations or state patterns. _(javascriptallonge.pdf (source-range-7239e085-01759))_
- And we don't need to worry about wrapping our values in an object with .done and .value properties. _(javascriptallonge.pdf (source-range-7239e085-01759))_
...
- in the older style of object-oriented programming, we built 'fat' objects. _(javascriptallonge.pdf (source-range-7239e085-01764))_
- If we wanted to flatten collections to arrays, we wrote a .toArray method for each type of collection. _(javascriptallonge.pdf (source-range-7239e085-01764))_
- We tell ourselves that, well, a collection ought to know how to map itself. _(javascriptallonge.pdf (source-range-7239e085-01765))_
...
- Some methods are only added to a few collections, some are added to all. _(javascriptallonge.pdf (source-range-7239e085-01765))_
- Each one has its own variation, but the overall form is identical. _(javascriptallonge.pdf (source-range-7239e085-01766))_
- But we end up recreating the same bits of code in each .map method we create, in each .reduce method we create, in each .filter method we create, and in each .find method. _(javascriptallonge.pdf (source-range-7239e085-01766))_
- That's a sign that we should work at a higher level of abstraction, and working with iterables is that higher level of abstraction. _(javascriptallonge.pdf (source-range-7239e085-01766))_
- That would be like saying that when we ask a bank teller for some cash, they personally print every bank note. _(javascriptallonge.pdf (source-range-7239e085-01767))_
- This 'fat object' style springs from a misunderstanding: When we say a collection should know how to perform a map over itself, we don't need for the collection to handle every single detail. _(javascriptallonge.pdf (source-range-7239e085-01767))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01771))_
...
- It maps to the squares of all 30 numbers, but our code for mapping an iteration returns an iterable that can iterate over the squares of our numbers, not an array or stack of the squares. _(javascriptallonge.pdf (source-range-7239e085-01791))_
...
- This is why 'pure' functional languages like Haskell combine lazy semantics with immutable collections, and why even 'impure' languages like Clojure emphasize the use of immutable collections. _(javascriptallonge.pdf (source-range-7239e085-01800))_
- If we mutate a collection after taking an iterable, we might get an unexpected result. _(javascriptallonge.pdf (source-range-7239e085-01800))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01784, source-range-7239e085-01786))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01789, source-range-7239e085-01792))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01793))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01795))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01798, source-range-7239e085-01800))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01802))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01802, source-range-7239e085-01806))_
...
- A few minutes later, he was joined by one of the company's developers, Christine. _(javascriptallonge.pdf (source-range-7239e085-01811))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01814))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01817))_
...
- The Carpenter coughed softly, then began. _(javascriptallonge.pdf (source-range-7239e085-01831))_
- I'll refactor a touch to make things clearer, for example I'll extract the board to make it easier to test:' _(javascriptallonge.pdf (source-range-7239e085-01831))_
- A statefulMap is a lazy map that preserves state from iteration to iteration. _(javascriptallonge.pdf (source-range-7239e085-01834))_
...
- That's what we need, because we need to know the current position to map each move to the next position.' _(javascriptallonge.pdf (source-range-7239e085-01834))_
- Detecting whether the game terminates is equivalent to detecting whether the graph contains a cycle.' _(javascriptallonge.pdf (source-range-7239e085-01841))_
- I approached this question in that spirit. _(javascriptallonge.pdf (source-range-7239e085-01844))_
- I have never forgotten the question, or the general form of the solution. _(javascriptallonge.pdf (source-range-7239e085-01846))_
- The question was, Given a linked list, detect whether it contains a cycle. _(javascriptallonge.pdf (source-range-7239e085-01846))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01831, source-range-7239e085-01834))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01835))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01840))_
...
- The Carpenter sat down and waited. _(javascriptallonge.pdf (source-range-7239e085-01853))_
- This type of solution provided an excellent opportunity to explore lazy versus eager evaluation, the performance of iterators versus native iteration, single responsibility design, and many other rich topics. _(javascriptallonge.pdf (source-range-7239e085-01853))_
- The Carpenter was confident that although nobody would write this exact code in production, prospective employers would also recognize that nobody would try to detect whether a chequer game terminates in production, either. _(javascriptallonge.pdf (source-range-7239e085-01854))_
- Christine looked at the solution on the board, frowned, and glanced at the clock on the wall. _(javascriptallonge.pdf (source-range-7239e085-01855))_
...
- We used generators to build iterators that maintain implicit state. _(javascriptallonge.pdf (source-range-7239e085-01873))_
- We saw how to use them for recursive unfolds and state machines. _(javascriptallonge.pdf (source-range-7239e085-01873))_
- But there are other times we want to build functions that maintain implicit state. _(javascriptallonge.pdf (source-range-7239e085-01873))_
- But of course, iterating over a stream of moves requires us to wait for the game to be over so we know what moves were made. _(javascriptallonge.pdf (source-range-7239e085-01876))_
- The moves a player makes are a stream of values, just like the contents of an array can be consider a stream of values. _(javascriptallonge.pdf (source-range-7239e085-01876))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01873))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01881))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01883))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01885))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01889))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01891))_
...
- We could plays naughts and crosses as a stateless function. _(javascriptallonge.pdf (source-range-7239e085-01895))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01897))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01899))_
...
- We can encode the board in several different ways. _(javascriptallonge.pdf (source-range-7239e085-01903))_

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01902))_

> [Figure] (p.276)

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01904))_

> Let's use an array. So this:

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01905))_

> [Figure] (p.276)

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01906))_

> Will be represented as:

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01907))_

> [Figure] (p.276)

**Atom:** _(javascriptallonge.pdf (source-range-7239e085-01909))_

> [Figure] (p.277)

## Will be represented as:

- We can use a POJO to make a map from positions to moves. _(javascriptallonge.pdf (source-range-7239e085-01912))_
- We'll use the [] notation for keys, it allows us to use any expression as a key, and JavaScript will convert it to a string. _(javascriptallonge.pdf (source-range-7239e085-01912))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01917))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01919))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01925))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01932, source-range-7239e085-01934))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01938, source-range-7239e085-01941))_
...
- We have looked at generators as ways of making iterators over static collections, where state is modelled implicitly in control flow. _(javascriptallonge.pdf (source-range-7239e085-01945))_
...
- Here are the operations we've defined on Iterables. _(javascriptallonge.pdf (source-range-7239e085-01948))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01954))_
...
- You can also install the transpilers on your development system and use them with Node 102 on the command line 103 . _(javascriptallonge.pdf (source-range-7239e085-01982))_

**Context:** _(javascriptallonge.pdf (source-range-7239e085-01966))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01968))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01970))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01972, source-range-7239e085-01976))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01977))_
...
**Context:** _(javascriptallonge.pdf (source-range-7239e085-01979))_
...
- But where The Little Schemer's primary focus is recursion, JavaScript Allongé's primary focus is functions as first-class values . _(javascriptallonge.pdf (source-range-7239e085-01988))_
- JavaScript Allongé was inspired by The Little Schemer 104 by Daniel Friedman and Matthias Felleisen. _(javascriptallonge.pdf (source-range-7239e085-01988))_
...
- 'Café Allongé, also called Espresso Lungo, is a drink midway between an Espresso and Americano in strength. There are two different ways to make it. The first, and the one I prefer, is to add a small amount of hot water to a double or quadruple Espresso Ristretto. Like adding a splash of water to wh — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00012))_
- This achieves approximately the same ratio of oils to water as the dilution method, but also releases a different mix of flavours due to the longer extraction. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00013))_
- 'The important thing is that neither method of preparation should use so much water as to result in a sickly, pale ghost of Espresso. Moderation in all things.' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00014))_
- JavaScript Allongé teaches you how to handle complex code, and it also teaches you how to simplify code without dumbing it down. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00019))_
- And presto, rest collects the rest of the arguments without a lot of malarky involving slicing arguments . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00038))_
- But there's more to it than that . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00043))_
- Thus, the focus on things like writing decorators. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00043))_
- And these techniques dovetail nicely with Allongé's focus on composing entities and working with functions. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00045))_
- It introduces iterators and generators. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00046))_
- It introduces the notion of implementing private properties with symbols. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00046))_
- Thus, the 'six' edition introduces classes and mixins. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00046))_
- We just call some of those functions constructors, others decorators, others functional mixins, and yet others, policies. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00047))_
- From functions flow many ideas, from decorators to methods to delegation to mixins, and onwards in so many fruitful directions. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00052))_
- There are reasons why the second form is more flexible, especially when used in combination with partial application, but does that outweigh the benefit of having an entire codebase do everything consistently the first way or the second way? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00061))_
- JavaScript Allongé introduces new aspects of programming with functions in each chapter, explaining exactly how JavaScript works. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00065))_
- This upgrade became ECMAScript 5. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00070))_
- - Better syntax for features that already exist (e.g. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00073))_
- For example: classes and modules. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00073))_
- - New functionality in the standard library. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00074))_
- - Completely new features. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00078))_
- For example: Generators, proxies and WeakMaps. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00078))_
- 2 http://www.2ality.com
4 http://exploringjs.com
3 http://ecmanauten.de — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00081))_
- Having written books myself, I know the pain of soliciting and receiving feedback. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00084))_
- matthew knox
A different kind of language requires a different kind of book.
JavaScript holds surprising depths-its scoping rules are neither strictly lexical nor strictly dynamic, and it supports procedural, object-oriented (in several flavors!), and functional programming. Many books try to hide m — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00091))_
- Besides, there's really no risk at all . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00093))_
- Prelude: Values and Expressions over Coffee
...
Imagine we are visiting our favourite coffee shop. They will make for you just about any drink you desire, from a short, intense  — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00099))_
- Say you hand the barista a café Cubano. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00101))_
- Is this an expression? A value? Neither? Or both? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00104))_
...
11 In some languages, expressions are a kind of value unto themselves and can be manipulated. The grandfathe — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00112))_
- In JavaScript, we test whether two values are identical with the === operator, and whether they are not identical with the !== operator: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00115))_
- And then you're shown another cup of coffee. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00117))_
- Well, JavaScript's third and fourth possibilities cover that. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00122))_
- So what kinds of values might be the same type and have the same contents, but not be considered identical to JavaScript? Let's meet a data structure that is very common in contemporary programming languages, the Array (other languages sometimes call it a List or a Vector). — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00131))_
- An array looks like this: [1, 2, 3] . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00132))_
- Most programmers never encounter the limit on the magnitude of an integer. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00147))_
- 13 http://en.wikipedia.org/wiki/Double-precision_floating-point_format
14 Implementations of JavaScript are free to handle larger numbers. For example, if you type 9007199254740991 + 9007199254740991 into node.js , it will happily report that the answer is 18014398509481982 . But code that depends u — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00152))_
- In a sense, they behave like little functions. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00160))_
- There are lots and lots more operators that can be used with numbers, including bitwise operators like | and & that allow you to operate directly on a number's binary representation, and a number of other operators that perform assignment or logical comparison that we will look at later. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00164))_
- For reasons of appeasing the JavaScript parser, we'll enclose our functions in parentheses: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00177))_
- Like arrays, every time you evaluate an expression to produce a function, you get a new function that is not identical to any other function, even if you use the same expression to generate it. 'Function' is a reference type. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00179))_
- Here's how we apply a function to some values in JavaScript: Let's say that fn_expr is an expression that when evaluated, produces a function. Let's call the arguments args . Here's how to apply a function to some arguments: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00182))_
- Since we aren't giving it any arguments, we'll simply write () after the expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00184))_
- If not… Welcome to the ALGOL family of programming languages! — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00186))_
- It evaluates to the same thing, 0 . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00199))_
- It takes two arguments, evaluates them both, and itself evaluates to the value of the right-hand argument. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00201))_
- So, this is a valid function: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00211))_
- - By evaluating a function that doesn't return a value (() => {})() , and; — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00227))_
- There's a third way, with JavaScript's void operator. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00229))_
- back on the block
...
20 As an exercise for the reader, we suggest you ask your friendly — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00234))_
- Something like: { statement 1 ; statement 2 ; statement 3 ; ... ; statement n } — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00237))_
- As you can see, a block with one expression does not behave like an expression, and a block with more than one expression does not behave like an expression constructed with the comma operator: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00245))_
- The return keyword creates a return statement that immediately terminates the function application and returns the result of evaluating its expression. For example: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00250))_
- Some languages simplify this by making everything an expression, but JavaScript maintains this distinction, so when learning JavaScript we also learn about statements like function declarations, for loops, if statements, and so forth. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00256))_
- We'll see a few more of these later. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00256))_
- Statements belong inside blocks and only inside blocks. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00256))_
- Secondary school mathematics discusses this. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00271))_
- Use them in the body, of course. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00276))_
- It's a function for calculating the circumference of a circle given the diameter. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00278))_
- To apply a function with an argument (or arguments), we put the argument (or arguments) within the parentheses, like this: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00279))_
- 22 The Argument Sketch from 'Monty Python's Previous Record' and 'Monty Python's Instant Record Collection' — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00282))_
- Expressions consist either of representations of values (like 3.14159265 , true , and undefined ), operators that combine expressions (like 3 + 2 ), some special forms like [1, 2, 3] for creating arrays out of expressions, or function ( arguments ) { body-statements } for creating functions. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00287))_
- A return statement accepts any valid JavaScript expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00288))_
- Or a function that returns an array, an array of functions, a function that returns an array of functions, and so forth: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00289))_
- Arguments and variables work the same way whether we're talking about (x) => (y) => x or just plain (x) => x . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00302))_
- - JavaScript parses this whole thing as an expression made up of several sub-expressions. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00308))_
- - Another, 2 , evaluates to the number 2. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00311))_
- - JavaScript now evaluates applying the function to the argument 2 . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00312))_
- When we combine our knowledge of value types, reference types, arguments, and closures, we'll understand why this function always evaluates to true no matter what argument 26 you apply it to: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00326))_
- And with that, we're ready to look at closures . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00326))_
- NaN in JavaScript behaves a lot like NULL in SQL. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00328))_
- Given ( some function )( some argument ) , we know that we apply the function to the argument, create an environment, bind the value of the argument to the name, and evaluate the function's expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00332))_
- Then we're going to take the value of that function and apply it to the argument 2 , something like this: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00336))_
- Now let's enjoy a relaxed Allongé before we continue! — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00341))_
- Up to now, we've only seen one way to 'bind' a variable, namely by passing in an argument with the same name. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00343))_
- has a free variable, but the entire expression refers to (x) => ... — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00348))_
- And now you can guess how we evaluate ((y) => x)(2) in the environment {y: 2, '..': {x: 1, ...}} . The variable x isn't in (y) => ... 's immediate environment, but it is in its parent's environment, so it evaluates to 1 and that's what ((y) => x)(2) returns even though it ended up ignoring its own a — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00357))_
- Only you call it with (1)(2)(3) instead of (1, 2, 3) . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00365))_
- JavaScript always searches for a binding starting with the functions own environment and then each parent in turn until it finds one. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00373))_
- But before we do so, there's one final question: Where does the ancestry start? If there's no other code in a file, what is (x) => x 's parent environment? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00379))_
- Sometimes, programmers wish to avoid this. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00381))_
- Create an environment for them, of course. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00381))_
- (diameter) => diameter * 3.14159265 What is this '3.14159265' number? PI 28 , obviously. We'd like to name it so that we can write something like: (diameter) => diameter * PI — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00387))_
- What do we put inside our new function that binds 3.14159265 to the name PI when evaluated? Our circumference function, of course: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00390))_
- It produces the same result as our previous expressions for a diameter-calculating function: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00400))_
- 'Exposes' naming PI first, and we have to look inside to find out why we care. So, should we should always write this? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00408))_
- Every time we invoke the outer function, we'll invoke the inner function. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00410))_
- And we could use it like this: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00417))_
- It doesn't incur the cost of a function invocation. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00422))_
- The const keyword introduces one or more bindings in the block that encloses it. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00422))_
- Even better, it puts the symbol (like PI ) close to the value ( 3.14159265 ). — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00422))_
- It works just as we want. Instead of: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00424))_
- That emphasizes one of the things JavaScript gets really, really right: Functions as 'first class entities. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00433))_
- Wecan bind more than one name-value pair by separating them with commas. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00434))_
- For readability, most people put one binding per line: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00434))_
- Let's back up and reconsider how closures work. What happens if we use parameters to bind two different values to the same name? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00449))_
- Here's the second formulation of our diameter function, bound to a name using an IIFE: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00450))_
- And we know that functions create environments. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00464))_
- Let's start, as above, by doing this with parameters. We'll start with: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00467))_
- Now we bind 3 to PI in an otherwise empty IIFE inside of our IIFE that binds 3.14159265 to PI . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00475))_
- We say that when we bind a variable using a parameter inside another binding, the inner binding shadows the outer binding. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00477))_
- So what about const . Does it work the same way? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00478))_
- Yes, names bound with const shadow enclosing bindings just like parameters. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00480))_
- That's why we made all these IIFEs. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00481))_
- Ah! const statements don't just shadow values bound within the environments created by functions, they shadow values bound within environments created by blocks! — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00484))_
- This is enormously important. Consider the alternative: What if const could be declared inside of a block, but it always bound the name in the function's scope. In that case, we'd see things like this: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00485))_
- Being able to bind a name inside of a block means that if the name is only needed in the block, we are not 'leaking' its binding to other parts of the code that do not need to interact with it. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00489))_
- The line n = n -2; rebinds a new value to the name n . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00494))_
- Let's get right to it. This code does not name a function: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00499))_
- It doesn't name the function 'repeat' for the same reason that const answer = 42 doesn't name the number 42 . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00501))_
- And here's (almost) the exact same function written using the function keyword: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00506))_
- - We introduce a function with the function keyword. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00509))_
- This still does not name a function, but as we noted above, functions written with the function keyword have an optional 'something else.' Could that 'something else' name a function? Yes, of course. 33 — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00518))_
- In this book we are not examining JavaScript's tooling such as debuggers baked into browsers, but we will note that when you are navigating call stacks in all modern tools, the function's binding name is ignored but its actual name is displayed, so naming functions is very useful even if they don't  — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00526))_
- As we've seen, JavaScript functions take values as arguments and return values. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00557))_
- Higher-order functions dominate JavaScript Allongé . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00560))_
- But before we go on, we'll talk about some specific types of higher-order functions. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00560))_
- combinators
...
If we were learning Combinatorial Logic, we'd start with — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00562))_
- Let's start with a useful combinator: Most programmers call it Compose , although the logicians call it the B combinator or 'Bluebird.' Here is the typical 37 programming implementation: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00564))_
- You'll find lots more perusing the recipes in this book. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00566))_
- function decorators
...
37 As we'll discuss later, this implementation of the B  — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00570))_
- You'll see other function decorators in the recipes, like once and maybe. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00578))_
- When you look at functions within functions in JavaScript, there's a bit of a 'spaghetti code' look to it. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00580))_
- When a function takes multiple arguments, we 'apply' the function to the arguments by evaluating it with all of the arguments, producing a value. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00591))_
- We don't want to fool around writing _. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00594))_
- This code implements a partial application of the map function by applying the function (n) => n * n as its second argument: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00595))_
- We'll discuss mapWith again. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00599))_
...
40 Modern JavaScript implementations provide a map method for arrays, but Underscore's imp — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00600))_
- Wegeneralized composition with the compose combinator. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00603))_
- Although arguments looks like an array, it isn't an array: It's more like an object 43 that happens to bind some values to properties with names that look like integers starting with zero: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00610))_
...
43 We'll look at arrays and plain old javascript objects in depth later. — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00613))_
- The magic names this and arguments have a different behaviour when you invoke a function that was defined with a fat arrow: Instead of being bound when the function is invoked, the fat arrow function always acquires the bindings for this and arguments from its enclosing scope, just like any other bi — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00619))_
- It's the same idea, after all. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00628))_
- Now our inner function binds arguments[0] every time it is invoked, so we get the same result as if we'd written function (column) { return column * column } . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00630))_
- - Expression bodies evaluate to the value of the expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00644))_
- - Function application creates a scope. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00648))_
- Partial Application
In Building Blocks, we discussed partial application, but we didn't write a generalized recipe for it. This is such a common tool that many libraries provide some form of partial application. You'll find examples in Lemonad 45 from Michael Fogus, Functional JavaScript 46 from Oli — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00659))_
- 45 https://github.com/fogus/lemonad 46 http://osteele.com/sources/javascript/functional/ 47 https://github.com/substack/node-ap 48 — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00663))_
- 'Unary' is a function decorator that modifies the number of arguments a function takes: Unary takes any function and turns it into a function taking exactly one argument. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00668))_
- In that example, it looks exactly like the mapping function you'll find in most languages: You pass it a function, and it calls the function with one argument, the element of the array. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00671))_
- JavaScript's map actually calls each function with three arguments: The element, the index of the element in the array, and the array itself. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00671))_
- However, that's not the whole story. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00671))_
- It takes an optional radix argument. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00676))_
- It takes a value and returns a function that always returns the value, but if you pass it a function, it executes the function for side-effects. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00687))_
- tap('espresso')((it) => { console.log(`Our drink is ' ${ it } '`) }); //=> Our drink is 'espresso' 'espresso' It's easy to turn off: tap('espresso')(); //=> 'espresso' Libraries like Underscore 49 use a version of tap that is 'uncurried:' _.tap('espresso', (it) => console.log(`Our drink is ' ${ it } — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00688))_
- And if we wish it to do nothing at all, We can write either tap('espresso')() or tap('espresso', null) — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00692))_
- It's also useful for working with object and instance methods. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00693))_
- 50 https://en.wikipedia.org/wiki/Monad_(functional_programming)#The_Maybe_monad
51 https://github.com/raganwald/andand — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00702))_
- As a bonus, maybe plays very nicely with instance methods, we'll discuss those later: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00706))_
- You pass it a function, and you get a function back. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00712))_
- It seems some people will only try blind dating once. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00714))_
- (Note: There are some subtleties with decorators like once that involve the intersection of state with methods. — _fragmentary: text ends with an unfinished clause_ _(javascriptallonge.pdf (source-range-7239e085-00715))_
- It accepts a coach, a captain, and an arbitrary number of players. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00719))_
- 53 Another history lesson. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00727))_
- We've seen operators that act on numeric values, like + and % . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00753))_
- is a unary prefix operator that negates its argument. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00759))_
- , && , and || , but we've said nothing about expressions or about passing other values. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00763))_
- (Many other languages that have a notion of truthiness consider zero and the empty string to be truthy, not falsy, so beware of blindly transliterating code from one language to another!) — _fragmentary: text ends with an unfinished clause_ _(javascriptallonge.pdf (source-range-7239e085-00766))_
- It's the only operator that takes three arguments. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00768))_
- 54 We will not discuss JavaScript's numeric behaviour in much depth in this book, but the most important thing to know is that it implements the IEEE Standard for Floating-Point Arithmetic (IEEE 754), a technical standard for floating-point computation established in 1985 by the Institute of Electri — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00769))_
- Our logical operators ! — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00777))_
- is the way we write 'is truthy' in JavaScript. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00780))_
- - && evaluates its left-hand expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00782))_
- -If its left-hand expression evaluates to something falsy, && returns the value of its lefthand expression without evaluating its right-hand expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00783))_
- -If its left-hand expression evaluates to something truthy, && evaluates its right-hand expression and returns the value of the right-hand expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00784))_
- - || evaluates its left-hand expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00785))_
- -If its left-hand expression evaluates to something truthy, || returns the value of its lefthand expression without evaluating its right-hand expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00786))_
- -If its left-hand expression evaluates to something false, || evaluates its right-hand expression and returns the value of the right-hand expression. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00787))_
- In JavaScript, && and || aren't boolean logical operators in the logical sense. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00790))_
- If n === 0 , JavaScript does not evaluate (n !== 1 && even(n -2)) . This is very important! Imagine that JavaScript evaluated both sides of the || operator before determining its value. n === 0 would be true. What about (n !== 1 && even(n -2)) ? Well, it would evaluate even(n 2) , or even(-2) — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00796))_
- and so on and so forth until JavaScript throws up its hands and runs out of stack space. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00797))_
- But that's not what happens. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00798))_
- It's best to think of || and && as control-flow operators. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00799))_
- This leads to the infinite recursion we fear. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00803))_
- is a logical operator, it always returns true or false . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00809))_
- We saw how to construct an array literal using [ , expressions, , and ] . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00841))_
- operation as a 'gather,' following Kyle Simpson's example. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00855))_
- Some other languages call them first and butFirst , or head and tail . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00855))_
- 57 https://en.wikipedia.org/wiki/CAR_and_CDR
58 Kyle Simpson is the author of You Don't Know JS, available here — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-00857))_
- to place the elements of an array inside another array. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00860))_
- , JavaScript assigns an empty array: ...they] = ["duck feet", "tiger tail"]; — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00868))_
- who] = ["duck feet", "tiger tail"]; And if there aren't any items to assign with ... — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00868))_
- Some languages support multiple return values: A function can return several things at once, like a value and an error code. This can easily be emulated in JavaScript with destructuring: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00871))_
- It is very much like an array literal. And consider how we bind values to parameter names: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00876))_
- It looks like destructuring. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00878))_
- It acts like destructuring. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00878))_
- Gathering works with parameters! — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00880))_
- We gather the rest of the parameters. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00881))_
- Armed with our definition of an empty list and with what we've already learned, we can build a great many functions that operate on arrays. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00897))_
- First, we pick what we call a terminal case . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00899))_
- But we don't know the length of rest . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00901))_
- 'Recursion' sometimes seems like an elaborate party trick. There's even a joke about this: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00906))_
- When promising students are trying to choose between pure mathematics and applied engineering, they are given a two-part aptitude test. In the first part, they are led to a laboratory bench and told to follow the instructions printed on the card. They find a bunsen burner, a sparker, a tap, an empty — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00907))_
- Of course, all the students know what to do: They fill the beaker with water, place the stand on the burner and the beaker on the stand, then they turn the burner on and use the sparker to ignite the flame. After a bit the water boils, and they turn off the burner and are lead to a second bench. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00908))_
- The engineers light the burner immediately. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00909))_
- Recursive algorithms follow the 'divide and conquer' strategy for solving a problem: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00910))_
- It's very useful and simple to understand. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00916))_
- We already know how to divide arrays into smaller pieces. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00917))_
- Wecanwrite it out using a ternary operator. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00933))_
- With the exception of the length example at the beginning, our examples so far all involve rebuilding a solution using spreads. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00936))_
- - Given the terminal case of an empty list, we return a 0 instead of an empty list, and; — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00939))_
- - We catenate the square of each element to the result of applying sumSquares to the rest of the elements. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00940))_
- Let's rewrite mapWith so that we can use it to sum squares. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00941))_
- Let's look at how. Here's our extremely simple mapWith function again: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00955))_
- This keeps on happening, so that JavaScript collects the values 1 , 2 , 3 , 4 , and 5 plus housekeeping information by the time it calls mapWith((x) => x * x, []) . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00962))_
- A'tail-call' occurs when a function's last act is to invoke another function, and then return whatever the other function returns. For example, consider the maybe function decorator: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-00968))_
- The first two don't return anything, they don't matter. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00970))_
- This lengthDelaysWork function calls itself in tail position. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00980))_
- But while we're doing that, it's annoying to remember to call it with a zero. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00980))_
- The naïve function for calcuating the factorial of a positive integer follows directly from the definition: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-00991))_
- Wesawearlier that destructuring parameters works the same way as destructuring assignment. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01011))_
- Much slower than the built-in .map method for arrays. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01019))_
- Every time we call mapWith , we're calling [...prepend, fn(first)] . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01020))_
- Worse, the JavaScript Engine actually copies the elements from prepend into the new array one at a time. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01021))_
- So here's a question: If this is such a slow approach, why do some examples of 'functional' algorithms work this exact way? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01025))_
- some history
Once upon a time, there was a programming language called Lisp 65 , an acronym for LISt Processing. 66 Lisp was one of the very first high-level languages, the very first implementation was written for the IBM 704 67 computer. (The very first FORTRAN implementation was also written for  — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01030))_
- Notice that though JavaScript displays our list as if it is composed of arrays nested within each other like Russian Dolls, in reality the arrays refer to each other with references, so [1,[2,[3,[4,[5,null]]]]] is actually more like: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01040))_
- But what about the rest of the list? cdr does the trick: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01045))_
- In Lisp, it's blazingly fast because it happens in hardware. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01047))_
- Again, it's just extracting a reference from a cons cell, it's very fast. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01047))_
- Getting back to JavaScript now, when we write [first, ...rest] to gather or spread arrays, we're emulating the semantics of car and cdr , but not the implementation. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01049))_
- We'll look at linked lists again when we look at Plain Old JavaScript Objects. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01051))_
- If [first, ...rest] is so slow, why does JavaScript use arrays instead of making everything a linked list? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01054))_
- In addition to the extra fetches to dereference pointers, pointer chasing suffers from cache misses. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01055))_
- Two objects created with separate evaluations have differing identities, just like arrays: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01075))_
- All containers can contain any value, including functions or other containers, like a fat arrow function: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01085))_
- (There are some other technical differences between binding a named function expression and using compact method syntax, but they are not relevant here. — _fragmentary: text ends with an unfinished clause_ _(javascriptallonge.pdf (source-range-7239e085-01093))_
- Just as we saw with arrays, we can write destructuring assignments with literal object syntax. So, we can write: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01095))_
- Well, well, well. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01114))_
- This isn't a bad thing by any stretch of the imagination. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01114))_
- Our mapWith function takes twice as long as a straight iteration, because it iterates over the entire list twice, once to map, and once to reverse the list. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01116))_
- Their identities stay the same, but not their structure. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01121))_
- JavaScript permits the reassignment of new values to existing bindings, as well as the reassignment and assignment of new values to elements of containers such as arrays and objects. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01138))_
- Languages like Haskell 70 don't permit mutation at all. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01142))_
- of a list: We aren't making a new list, we're using some of the old list. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01147))_
- In general, it's easier to reason about data that doesn't change. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01151))_
- So back to avoiding mutation. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01151))_
- Consider our copy algorithm. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01153))_
- The line n = n -2; rebinds a new value to the name n . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01165))_
- We took the time to carefully examine what happens with bindings in environments. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01170))_
- However, if we don't shadow age with let , reassigning within the block changes the original: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01176))_
- It then rebinds the name in that environment. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01178))_
- Some programmers dislike deliberately shadowing variables. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01180))_
- If you buy that argument, the way that shadowing works in JavaScript exists to protect us from accidentally shadowing a variable when we move code around. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01180))_
- Named function expressions bind names. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01189))_
- Well, parameters bind names. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01189))_
- So that's five different ways so far. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01189))_
- Function declarations bind names. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01189))_
- But of course, it's not exactly like let . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01191))_
- It's just different enough to present a source of confusion. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01191))_
- JavaScript hoists the declaration, but not the assignment. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01198))_
- It looks a lot like the for loop in C. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01203))_
- About 30 seconds later Gauss gave him the answer. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01206))_
- Of course Gauss came up with the answer about 20 times faster than the other kids. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01206))_
- So far, so good. Hey, remember that functions in JavaScript are values? Let's get fancy! — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01209))_
- Again, so far, so good. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01211))_
- That's not what we want at all. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01215))_
- Now we're creating a new inner parameter, i and binding it to the value of the outer i . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01220))_
- And therefore, modifications to the parent also modify the child, and modifications to the child also modify the parent. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01229))_
- before we go any further, let's write a few naïve list utilities so that we can work at a slightly higher level of abstraction: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01234))_
- Our new at and set functions behave similarly to array[index] and array[index] = value . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01237))_
- So back to the problem of structure sharing. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01239))_
- There's also a bug: What happens when we modify the first element of a list? But before we fix that, let's try being lazy about copying. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01243))_
- In case we modify a child list. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01245))_
- Like all strategies, it makes a tradeoff: It's much cheaper than pessimistically copying structures when you make an infrequent number of small changes, but if you tend to make a lot of changes to some that you aren't sharing, it's more expensive. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01254))_
- I'm not particularly surprised that I couldn't think up an answer in a few minutes at the time. And to the interviewer's credit, he didn't terminate the interview on the spot, he asked me to describe the kinds of things going through my head. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01259))_
- I then forgot about it for a while. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01261))_
- I sent him an email sharing my result, to demonstrate my ability to follow through. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01261))_
- At the time, I couldn't think of any way to use hashing to solve the problem, so I gave up and tried to fit this into a powers-of-two algorithm. My first pass at it was clumsy, but it was roughly equivalent to this: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01266))_
- In Functional Iterators, we'll investigate one pattern for separating these concerns. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01269))_
- Let's consider a remarkably simple problem: Finding the sum of the elements of an array. In tailrecursive style, it looks like this: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01272))_
- As we saw earlier, this entangles the mechanism of traversing the array with the business of summing the bits. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01274))_
- What happens when we want to sum a tree of numbers? Or a linked list of numbers? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01277))_
- Once again, we're mixing the code for iterating over an array with the code for calculating a sum. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01288))_
- We haven't written anything that finds the first element of an iteration that meets a certain criteria. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01317))_
- So as you traverse the new decorator, you're changing the state of the original! — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01323))_
- To Mock a Mockingbird 76 established the metaphor of songbirds for the combinators, and ever since then logicians have called the K combinator a 'kestrel,' the B combinator a 'bluebird,' and so forth. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01332))_
- Let's start with some of the building blocks of combinatory logic, the K, I, and V combinators, nicknamed the 'Kestrel', the 'Idiot Bird', and the 'Vireo:' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01334))_
...
77 http://oscin.es — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-01335))_
- Now we'll take it one more step forward: Passing a value to K gets a function back, and passing a value to that function gets us a value. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01341))_
- Very simple, but useful. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01341))_
- From what we just wrote, K(x)(y) => x So K(I)(x) => I . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01345))_
- Now, an interesting thing happens when we pass functions to each other. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01345))_
- Given two values, K(I) always returns the second value. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01348))_
- You pass the data to these functions, and they extract it. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01358))_
- You call them and pass them the bits, and they choose what to return. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01359))_
- But the first and second we built out of K and I don't work that way. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01359))_
- It's exactly backwards of the way we write functions that operate on data. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01362))_
- And instead of passing latin to first or second , we pass first or second to latin . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01362))_
- For arrays, we'd write cons = (first, second) => [first, second] . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01364))_
- For 'data' we access with K and K(I) , our 'structure' is the function (selector) => selector("primus")("secundus") . Let's extract those into parameters: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01365))_
- Let's try it, we'll use the word pair for the function that makes data (When we need to refer to a specific pair, we'll use the name aPair by default): — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01369))_
- Armed with nothing more than K , I , and V , we can make a little data structure that holds two values, the cons cell of Lisp and the node of a linked list. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01375))_
- Without arrays, and without objects, just with functions. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01375))_
- We'd better try it out to check. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01375))_
- But without building our way up to something insane like writing a JavaScript interpreter using JavaScript functions and no other data structures, let's take things another step in a slightly different direction. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01386))_
- Instead of writing length(list) and examining a list, we'll write something like: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01392))_
- (Knowing that it can be done, on the other hand, is very important to understanding computer science.) — _fragmentary: text ends with an unfinished clause_ _(javascriptallonge.pdf (source-range-7239e085-01404))_
- It's the QED of physics that underpins the Maxwell's Equations of programming. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01405))_
- Deeply important, but not practical when you're building a bridge. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01405))_
- 79 https://en.wikipedia.org/wiki/Church_encoding
81 https://en.wikipedia.org/wiki/Gauge_boson
80 https://en.wikipedia.org/wiki/Surreal_number — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01406))_
- So what is interesting about this? What nags at our brain as we're falling asleep after working our way through this? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01407))_
- The same thing happens with our lists. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01414))_
- We won't bother here, but it's easy to see how to swap our functions out and replace them with an array. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01417))_
- The line node === EMPTY presumes a lot of things. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01419))_
- - And instead of testing some property of an entity and making a choice of our own with ?: (or if ), pass the entity the work we want done for each case and let it test itself. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01423))_
- This recipe isn't for map : It's for mapWith , a function that wraps around map and turns any other function into a mapper. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01434))_
- It reverses the arguments, taking the function first and the list second. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01436))_
- mapWith differs from map in two ways. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01436))_
- It also 'curries' the function: Instead of taking two arguments, it takes one argument and returns a function that takes another argument. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01436))_
- It's the same idea, after all. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01440))_
- Both patterns take us to the same destination: Composing functions out of common pieces, rather than building them entirely from scratch. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01444))_
- Let's consider the case whether we have a map function of our own, perhaps from the allong.es 84 library, perhaps from Underscore 85 . We could write our function something like this: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01450))_
- First, we're reversing the order of arguments. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01452))_
- Looking at this, we see we're conflating two separate transformations. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01452))_
- Second, we're 'currying' the function so that instead of defining a function that takes two arguments, it returns a function that takes the first argument and returns a function that takes the second argument and applies them both, like this: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01454))_
- Let's return to the implementation of mapWith that relies on a map function rather than a method: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01456))_
- We're going to extract these two operations by refactoring our function to paramaterize map . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01458))_
- 84 https://github.com/raganwald/allong.es
85 http://underscorejs.org — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-01463))_
- Assigning properties from one object to another (also called 'cloning' or 'shallow copying') is a basic building block that we will later use to implement more advanced paradigms like mixins. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01485))_
- Use it as an excuse to get familiar with your environment's debugging facility. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01491))_
- Work things out for yourself! — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01495))_
- For example, the escape sequence \n inserts a newline character in a string literal, like this: 'first line\nsecond line' . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01500))_
- Quasi-literals go much further. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01507))_
- Like any other expression, quasi-literals are evaluated late , when that line or lines of code is evaluated. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01516))_
- Sometimes you just want to move the box around. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01528))_
- Things like 'put a label on every bag of coffee in this box,' Or, 'Open the box, take out the bags of decaf, and make a new box with just the decaf.' Or, 'go through the bags in this box, and take out the first one marked 'Espresso' that contains at least 454 grams of beans.' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01529))_
- All of these actions involve going through the contents one by one. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01530))_
- The way we've written .iterator as a method, each object knows how to return an iterator for itself. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01535))_
- We can use it with our stack: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01539))_
- And there's one more thing: You recall that the spread operator ( ... — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01564))_
- One caveat of spreading iterables: JavaScript creates an array out of the elements of the iterable. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01570))_
- It's the same idea, after all. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01588))_
- We invoke mapWith((x) => 2 * x, Numbers) and get Evens . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01593))_
- Every time we write for (const i of Evens) , JavaScript calls Evens[Symbol.iterator]() . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01595))_
- So we call it a collection operation . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01596))_
- The Numbers iterable returns an object that updates a mutable variable, n , to deliver number after number. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01629))_
- Well, we've written our iterator as a server . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01630))_
- Then it waits for the next request. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01630))_
- It waits until given a request, and then it returns exactly one item. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01630))_
- They're of approximately equal complexity. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01635))_
- For example, iterating over a tree. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01638))_
- We'll write a functional iterator to keep things simple, but it's easy to see the shape of the basic problem: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01640))_
- Now for the iteration version. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01640))_
- Not a fat arrow. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01663))_
- Not a plain function . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01663))_
- - We declare the function using the function * syntax. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01663))_
- We 'yield' values using the yield keyword. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01664))_
- - We don't return values or output them to console.log . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01664))_
- Whenweinvokethe function, we get an iterator object back. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01665))_
- We call its .next() method, but it's done immediately. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01667))_
- 91 Wewrote a generator declaration . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01669))_
- It yields the value of something , and then it's done. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01675))_
- - We call oneTwoThree() and get an iterator. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01680))_
- - The body of our generator runs until it returns, ends, or encounters a yield statement, which is yield 1; . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01683))_
- - The iterator suspends its execution . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01684))_
- - The iterator wraps 1 in {done: false, value: 1} and returns that from the call to .next() . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01685))_
- - The body of our generator runs until it returns, ends, or encounters the next yield statement, which is yield 2; . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01688))_
- - The iterator suspends its execution . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01689))_
- - The iterator wraps 2 in {done: false, value: 2} and returns that from the call to .next() . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01690))_
- - The body of our generator runs until it returns, ends, or encounters the next yield statement, which is yield 3; . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01693))_
- - The iterator suspends its execution . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01694))_
- - The iterator wraps 3 in {done: false, value: 3} and returns that from the call to .next() . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01695))_
- - The iterator returns {done: true} from the call to .next() , and every call to this iterator's .next() method will return {done: true} from now on. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01699))_
- When the consumer calls .next() , it 'suspends' and the producer starts running. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01702))_
- When the producer yields a value, the producer suspends and the consumer starts running, taking the value from the result of calling .next() . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01702))_
- It's a function that returns an iterator when we invoke it. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01708))_
- Now we can use it in a for...of loop, spread it into an array literal, or spread it into a function invocation, because we have written an iterable that uses a generator to return an iterator from its [Symbol.iterator] method. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01711))_
- Of course, we could just as easily write a generator function for Fibonacci numbers: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01726))_
- Here's a first crack at a function that returns an iterable object for iterating over trees: — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01729))_
- We've gone with the full iterable here, a TreeIterable(iterable) returns an iterable that treats iterable as a tree. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01731))_
- JavaScript handles the recursion for us using its own execution stack. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01735))_
- These three lines say, in essence, 'yield all the elements of TreeIterable(e) , in order. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01738))_
- append iterates over a collection of iterables, one element at a time. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01740))_
- Tucked inside of it is the same three-line idiom for yielding each element of an iterable. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01741))_
- The operations on iterables are tremendously valuable, but let's reiterate why we care: In JavaScript, we build single-responsibility objects, and single-responsibility functions, and we compose these together to build more full-featured objects and algorithms. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01762))_
- Each collection knew how to map itself ( .map ), how to fold itself ( .reduce ), how to filter itself ( .filter ) and how to find one element within itself ( .find ). — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01764))_
- Over time, this informal 'interface' for collections grows by accretion. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01765))_
- But our objects grow fatter and fatter. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01765))_
- Both expressions evaluate to 220 . — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01786))_
- But it's still illustrative to dissect something important: Array's .map and .filter methods gather their results into new arrays. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01787))_
- Whereas the .map and .filter methods on Pair work with iterators. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01788))_
- This reduces the memory footprint. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01788))_
- Arrays copy-on-read, so every time we perform a map or filter, we get a new array and perform all the computations. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01797))_
- You recall we briefly touched on the idea of infinite collections? Let's make iterable numbers. They have to be lazy, otherwise we couldn't write things like: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01798))_
- Balanced against their flexibility, our 'lazy collections' use structure sharing. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01800))_
- 'The Carpenter' was a JavaScript programmer, well-known for a meticulous attention to detail and love for hand-crafted, exquisitely joined code. The Carpenter normally worked through personal referrals, but from time to time a recruiter would slip through his screen. One such recruiter was Bob Pliss — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01810))_
- On each square, we randomly place an arrow pointing to one of its four sides. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01818))_
- Consider a finite checkerboard of unknown size. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01818))_
- As the player moves the chequer, they calls out the direction of movement, e.g. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01819))_
- A player moves the chequer, following the rules. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01819))_
- 95 http://babeljs.io
96 http://www.es6fiddle.net — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-01825))_
- 'What,' Christine asked, 'Do you write in place of the three // ??? placeholders to determine whether the game halts?' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01826))_
- And just as companies often pick a problem that gives them broad latitude for discussing alternate approaches and determining that depth of a candidate's experience, The Carpenter liked to sketch out solutions that provided an opportunity to judge the interviewer's experience and provide an easy exc — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01829))_
- For that, we'll map the Game iterable to positions. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01834))_
- 'This is a standard idiom we can obtain from libraries, we don't reinvent the wheel. I'll show it here for clarity:' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01835))_
- 'Armed with this, it's straightforward to map an iterable of directions to an iterable of strings representing positions:' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01838))_
- The Carpenter reflected. 'Having turned our game loop into an iterable, we can now see that our problem of whether the game terminates is isomorphic to the problem of detecting whether the positions given ever repeat themselves: If the chequer ever returns to a position it has previously visited, it — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01840))_
- 'This is, of course, the most common solution, it is Floyd's cycle-finding algorithm 97 , although there is some academic dispute as to whether Robert Floyd actually discovered it or was misattributed by Knuth.' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01847))_
- It also cleanly separates the mechanics of the game from the algorithm for detecting cycles in a graph.' — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01851))_
- 'We at the Thing Software company are very grateful you made some time to visit with us, but alas, that is all the time we have today. If we wish to talk to you further, we'll be in touch.' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01856))_
- The Carpenter never did hear back from them, but the next day there was an email containing a generous contract from Friends of Ghosts ('FOG'), a codename for a stealth startup doing interesting work, and the Thing interview was forgotten. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01857))_
- Some time later, The Carpenter ran into Bob Plissken at a local technology meet-up. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01858))_
- The Carpenter smiled. 'I forgot about them, it's been a while. So, do They Live?' — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01859))_
- You're essentially calling for the player to clone themselves and call out the directions in parallel.' — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01866))_
- The Carpenter thought about this for a moment. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01867))_
- Consider, for example, the moves in a game. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01876))_
- To save space, we'll ignore rotations and reflections, and we'll model the first player's moves as a stream. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01877))_
- Let's consider move 1 . That produces this board: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01883))_
- For 2 , 4 , 5 , 7 , or 8 , we play 3 and win. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01889))_
- If x plays anything else, including 7 , we play 4 and win. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01893))_
- If x plays 4 , we play 7 and win. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01893))_
- We encode each position of the board in some fashion, and then we build a dictionary from positions to moves. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01895))_
- Let's use an array. So this: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01904))_
- Our statelessNaughtsAndCrosses function pushes the work of tracking the game's state onto us, the player. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01922))_
- We've done almost the exact same thing here with our naughts and crosses game. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01931))_
- We aren't calling our function with moves, it's calling us. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01935))_
- However, our solution inverts the control. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01935))_
- Canwedothesamethinghere?Atfirst glance, no. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01936))_
- If it was possible, how would it work? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-01939))_
- Thereafter, we call .next(...) and pass in our moves (The very first call has to be .next() without any arguments, because the generator hasn't started yet. — _fragmentary: text ends with an unfinished clause_ _(javascriptallonge.pdf (source-range-7239e085-01941))_
- Our generator function maintains state implicitly in its control flow, but returns an iterator that we call, it doesn't call us. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-01942))_
- 102 http://nodejs.org/
103 https://en.wikipedia.org/wiki/REPL — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-01983))_
- 106 http://www.flickr.com/photos/trumpetca/
http://creativecommons.org/licenses/by/2.0/deed.en
107 http://www.flickr.com/photos/avlxyz/4907262046 108 http://creativecommons.org/licenses/by-sa/2.0/deed.en 109 http://www.flickr.com/photos/digitalcolony/5054568279/ 110 http://creativecommons.org/licens — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-02011))_
- 163 http://www.flickr.com/photos/93425126@N00/313053257/ 164 http://creativecommons.org/licenses/by-sa/2.0/deed.en 165 http://www.flickr.com/photos/digitalcolony/2833809436/ 166 http://creativecommons.org/licenses/by-sa/2.0/deed.en 167 http://www.flickr.com/photos/citizenhelder/5006498068/ 168 http: — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-02045))_
...
199 https://www.flickr.c — _unextracted: segment carries subject matter but no structured claim was recovered_ _(javascriptallonge.pdf (source-range-7239e085-02057))_
- He writes about programming on 'Raganwald 222 ,' as well as general-purpose ruminations on 'Braythwayt Dot Com 223 '. — _fragmentary: no subject/predicate region recovered_ _(javascriptallonge.pdf (source-range-7239e085-02060))_
- 221 http://github.com/raganwald
223 http://braythwayt.com
222 http://raganwald
224 https://twitter.com/raganwald
225 mailto:reg@braythwayt.com — _partial-parse: table parsed as enumerated rows_ _(javascriptallonge.pdf (source-range-7239e085-02065))_
