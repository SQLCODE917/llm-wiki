...
projection_coverage: topic-sword-world-rpg-complete-edition-strike@8126109cf15315b29391d9b4166f6c6a
---

# Strike

What [[sword-world-rpg-complete-edition]] covers about strike:
...
- [[sword-world-rpg-complete-edition-power]] - shared statements and technical atoms: Power shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction .; Power shares technical record from Determining Base Damage (Strike Roll): Table 4-2: Rating Table, Key Number Column 14 (35 shared statement(s), 21 shared atom(s))
- [[sword-world-rpg-complete-edition-result]] - shared statements and technical atoms: Result shares source evidence from 4.6.5 Final Damage: The final damage your character suffers from a monster equals the monster's strike points minus the result of your defense roll plus your character's damage reduction .; Result shares technical record from Determining Base Damage (Strike Roll): Table 4-2: Rating Table, Key Number Column 14 (5 shared statement(s), 6 shared atom(s))
- [[sword-world-rpg-complete-edition-resist]] - shared statements and technical atoms: Resist shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Resist shares technical record from [ Lightning Bind ]: Effect=Capture the target with a net of electricity, which deals strike power 20 damage each round. (4 shared statement(s), 6 shared atom(s))
- [[sword-world-rpg-complete-edition-target]] - shared statements and technical atoms: Target shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction .; Target shares technical record from [ Lightning Bind ]: Effect=Capture the target with a net of electricity, which deals strike power 20 damage each round. (4 shared statement(s), 6 shared atom(s))
- [[sword-world-rpg-complete-edition-spell]] - shared statements and technical atoms: Spell shares source evidence from [ Fire Weapon ]: This is a spell used on weapons. The targeted weapon will now emit a magical flame from its striking end, adding a +10 bonus to the weapon's own strike power. This s ... [truncated]; Spell shares technical record from [ Lightning Bind ]: Effect=Capture the target with a net of electricity, which deals strike power 20 damage each round. (2 shared statement(s), 6 shared atom(s))
...
- [[sword-world-rpg-complete-edition-character]] - shared statements and technical atoms: Character shares source evidence from Determining Base Damage (Strike Roll): On the table, look at the column where the key number equals your character's strike power . For example, if your character's strike power is 14, you only need to lo ... [truncated]; Character shares technical record from Determining Base Damage (Strike Roll): Table 4-2: Rating Table, Key Number Column 14 (2 shared statement(s), 4 shared atom(s))
- [[sword-world-rpg-complete-edition-base]] - shared statements and technical atoms: Base shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Base shares technical record from Determining Base Damage (Strike Roll): Table 4-2: Rating Table, Key Number Column 14 (2 shared statement(s), 3 shared atom(s))
- [[sword-world-rpg-complete-edition-effect]] - shared statements and technical atoms: Effect shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Effect shares technical record from [ Missile Protection ] (Sylph/Wind Spirit): Type=Countered (Negated) By: Shoot Arrow Expansion=Duration, distance, area (2 shared statement(s), 3 shared atom(s))
- [[sword-world-rpg-complete-edition-score]] - shared statements and technical atoms: Score shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Score shares technical record from 5th Level Spirit Magic List [ Control Plant ]: Strike Points=10 Defense Points=7 (4 shared statement(s), 2 shared atom(s))
...
- [[sword-world-rpg-complete-edition-meter]] - shared statements and technical atoms: Meter shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Meter shares technical record from [ Shade ]: Life Points/Resistance=1/8 (1) (2 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-type]] - shared statements and technical atoms: Type shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Type shares technical record from [ Shoot Arrow ] (Sylph/Wind Spirit): Note that this spell cannot deal damage to monsters that can only be wounded by silver or magical weapons, such as werewolves, etc. (2 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-cast]] - shared statements and technical atoms: Cast shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Cast shares technical record from [ Shoot Arrow ] (Sylph/Wind Spirit): Note that this spell cannot deal damage to monsters that can only be wounded by silver or magical weapons, such as werewolves, etc. (1 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-caster]] - shared statements and technical atoms: Caster shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated]; Caster shares technical record from [ Shoot Arrow ] (Sylph/Wind Spirit): Note that this spell cannot deal damage to monsters that can only be wounded by silver or magical weapons, such as werewolves, etc. (1 shared statement(s), 2 shared atom(s))
- [[sword-world-rpg-complete-edition-damage-reduction]] - shared statements and technical atoms: 【 Damage Reduction 】 shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction .; 【 Damage Reduction 】 shares technical record from 4.6.5 Final Damage: Final damage = monster's strike points - (defense roll result + damage reduction) (2 shared statement(s), 1 shared atom(s))
...
- [[sword-world-rpg-complete-edition-undead]] - shared technical atoms: Undead shares technical record from [ Holy Weapon ]: Expansion=Duration, distance, targets (4 shared atom(s))
...
- [[sword-world-rpg-complete-edition-level]] - shared technical atoms: Level shares technical table: 5.1.13 Spirit Magic and the Shaman Skill 5.1.13 Spirit Magic  and the Shaman Skil Silent spirit are runes used to communicate with spirits and draw out the  power  c ... [truncated] (1 shared atom(s))
...
- [[sword-world-rpg-complete-edition-spirit]] - shared technical atoms: Spirit shares technical table: 5.1.13 Spirit Magic and the Shaman Skill 5.1.13 Spirit Magic  and the Shaman Skil Silent spirit are runes used to communicate with spirits and draw out the  power  c ... [truncated] (1 shared atom(s))
- [[sword-world-rpg-complete-edition-bonus-damage]] - shared statements: 【 Bonus Damage 】 shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction . (9 shared statement(s))
- [[sword-world-rpg-complete-edition-bonus]] - shared statements: Bonus shares source evidence from Scores Used in Weapon Combat: Attack power , strike power , bonus damage , critical target , evasion speed , defense power , and damage reduction . (4 shared statement(s))
- [[sword-world-rpg-complete-edition-area]] - shared statements: Area shares source evidence from [ Lightning ]: Base Mental Power Cost=15 Distance=Caster Area=A space 1 meter high and wide and 20 meters long Duration=Instant Effect=Emits strike power 20 lightning Type=Damage ( ... [truncated] (2 shared statement(s))
- [[sword-world-rpg-complete-edition-ability]] - shared statements: Ability shares source evidence from 《 Camouflage 》: Monsters with this ability disguise themselves in a particular way, wait for a victim to approach, then strike when he or she is not careful. To discover this, you m ... [truncated] (1 shared statement(s))
...
- [[sword-world-rpg-complete-edition-section-strike-points-15dde443]] - source section: 《 Strike Points shares source evidence from 《 Strike Points: This represents the amount of damage dealt by the monster. If a character fails to evade their attack, these strike points become damage and reduce the character's l ... [truncated]; 《 Strike Points shares technical record from 《 Strike Points: If a character fails to evade their attack, these strike points become damage and reduce the character's life force. (3 shared statement(s), 2 shared atom(s))
