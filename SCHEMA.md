...
- `harness/cache/page-plans/<source-run>/ledger/` — generated ingest artifacts:
  the claim ledger, section plan, topic index, coverage maps, and quality
  reports that explain how a raw source became wiki pages. These artifacts are
  rebuildable from `raw/` and never count as cited source evidence.
