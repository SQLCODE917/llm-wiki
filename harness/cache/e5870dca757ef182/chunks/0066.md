...
## **How to Read the Structure Strength Table** 
...
damage than these minimum destruction points with a _single blow_ , you will _not_ be able to destroy a structure with 0 defense points. 

## **Destruction Points** 

As expected, it indicates the strength of the material, and the game master must determine a specific score depending on the thickness. The lowest of this score is called the _minimum destruction points_ . In the case of paper, the score is 1~10, so the minimum destruction points are **1** . 
...
Beyond this, game masters should also use common sense. There's no mention of entangling weapons, but there's no way they can do any damage. 
...
Also, be aware of the number of people working as a group when creating holes. When making a hole large enough for a person to fit through, at most two people can work together. 
...
even weapons that cannot cause criticals will now be able to cause criticals (defense points are effective). 
...
## **Handling Spirit Walls** 

When using these rules for destroying structures to destroy the spirit magic Spirit Wall, please do so as follows. 

**[   Spirit Wall: Gnome   ]** Treat it as a _stone_ wall. Without expansion, defense points are 15 and 

destruction points are 20. Its minimum destruction points are 1 because it's stone. 

## **[   Spirit Wall: Frau   ]** 

Treat it as an _ice_ wall. Without expansion, defense points are 15 and destruction points are 20. Its minimum destruction points are 1 because it's ice. 

## **[   Spirit Wall: Dryad   ]** 

Treat it as a _vegetation_ wall. Without expansion, defense points and destruction points are both 15. 

_Spirit Wall: Dryad_ has the power to regenerate even if it’s destroyed. Each round, _Spirit Wall: Dryad_ regenerates 1 defense point and 1 destruction point. 


![](harness/cache/e5870dca757ef182/images/Sword_World_RPG_-_Complete_Edition.pdf-0279-10.jpg)
