    ...
    def render(self) -> str:
        return "\n\n".join(
            [
                ...
                "## Technical Atom Catalogs\n\n"
                + (self.technical_atom_summary or "No technical atom catalogs."),
...
def build_curator_status(
    *,
    ...
    return CuratorStatus(
        ...
        technical_atom_summary=technical_atom_summary,
