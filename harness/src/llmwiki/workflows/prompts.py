...
INTEGRATE_TEMPLATE = _BASE + (
    ...
    "only a few related-material pages. Read individual pages only for a "
    "spot-check; do not spend the integrate pass rereading large chapter "
    "pages when the page map already supplies the navigation structure. "
