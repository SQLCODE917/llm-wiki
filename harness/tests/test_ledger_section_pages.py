...
def test_section_pages_roll_up_descendants_and_link_repeated_topic_contexts() -> None:
    ...
    assert f"[[{chapter_id}]] - broader source section: 1.4 Character Creation" in by_id[combat_id]
    assert (
    ...
    assert (
        ...
        "heading, 1.4 Character Creation / Filling out the Character Sheet" in by_id[combat_id]
    )
